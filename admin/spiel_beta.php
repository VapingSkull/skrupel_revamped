  ...
  if ($spielanzahl>=1) {
   ?><center><table border="0" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td><img src="<?php echo servername;?>bilder/empty.gif" height="22" width="1"></td>
      </tr>
   <?php
  ...
  $spieler_10_raus=$array["spieler_10_raus"];
   ...
   ?>
    <tr>
      ...
      if ($spieler_1>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_1 order by id");
      ...
      if ($spieler_2>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_2 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_3>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_3 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_4>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_4 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_5>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_5 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_6>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_6 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_7>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_7 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_8>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_8 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_9>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_9 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
      ...
      if ($spieler_10>=1) {
        $zeiger_temp= @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_10 order by id");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        $username=$array_temp["nick"];
     ...
     <tr><td><form name="formular"  method="post" action="<?php echo servername;?>admin/spiel_beta.php?fu=2&slot_id=<?php echo $slot_id; ?>"></td>
...
<table border="0" cellspacing="0" cellpadding="0">
     <tr><td><form name="formular"  method="post" action="<?php echo servername;?>admin/spiel_beta.php?fu=4&slot_id=<?php echo $spiel; ?>"></td>
...
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td style="font-size:20px; font-weight:bold; filter:DropShadow(color=black, offx=2, offy=2)"><?php echo $lang['admin']['spiel']['beta']['optionen']?></td></tr></table></center>
   ...
   <tr><td><form name="formular"  method="post" action="<?php echo servername;?>admin/spiel_beta.php?fu=3&slot_id=<?php echo $spiel; ?>">&nbsp;</td></tr>
  ...
  for($li=1;$li<11;$li++){?>
    ...
    if(($spieler_id_c[$li]>0)and($spieler_raus_c[$li]==0)){ 
      $zeiger3 = @mysql_query("SELECT * FROM $skrupel_user where id=$spieler_id_c[$li] order by id");
...
if ($fuid==3) {
  ...
  $zeiger = @mysql_query("SELECT spiel,partei_a,partei_b,status,optionen FROM $skrupel_politik where spiel=$spiel order by spiel");
  ...
  <center><table border="0" height="100%" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <center><table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><form name="formular"  method="post" action="<?php echo servername;?>admin/spiel_beta.php?fu=2&slot_id=<?php echo $spiel;?>"></td>
...
<script language=JavaScript>
  window.location='<?php echo servername;?>admin/spiel_beta.php?fu=5&slot_id=<?php echo $spiel; ?>';
 </script>
<?php
} include ("inc.footer.php");
 }
...
for ($mn=1;$mn<11;$mn++) {
    /*
     * ($spieler_id_c[$mn]==$mn) was ($spieler_id_c[$mn]==$spieler_id) before changing
     */
    if ($spieler_id_c[$mn]==$mn) {$spieler=$mn;$spieler_raus=$spieler_raus_c[$mn];$zug_abgeschlossen=$spieler_zug_c[$mn];$spieler_rasse=$spieler_rasse_c[$mn];$spieler_ziel=$spieler_ziel_c[$mn];}
}
    }
$main_verzeichnis="../";
  		...
  		<tr>
    		<td><?php echo $lang['admin']['spiel']['beta']['fertig']?><br><br><br>
    			...
    			<table border="0" cellspacing="0" cellpadding="0">
    				<tr>
						<td><form name="formular"  method="post" action="<?php echo servername;?>/admin/spiel_beta.php?fu=2&slot_id=<?php echo $spiel; ?>"></td>
						<td><input type="submit" name="bla" value="<?php echo $lang['admin']['spiel']['beta']['zurueck']?>"></td>
						<td></form></td>
					</tr>
				</table>
				</center>
