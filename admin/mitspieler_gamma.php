...
?>
  ...
  $spielanzahl=0;
  $zeiger2 = @mysql_query("SELECT name,
                                  spieler_1,
                                  spieler_2,
                                  spieler_3,
                                  spieler_4,
...
<?php if ($spielanzahl>=1) { ?>
     ...
     <td></td></tr>
<?php } else { ?>
     <tr><td><form name="formular"  method="post" action="<?php echo servername;?>admin/mitspieler_gamma.php?fu=2&spieler_id=<?php echo $id; ?>" onsubmit="return confirm('<?php echo str_replace('{1}',$nick,$lang['admin']['mitspieler']['gamma']['wirklich']);?>');"></td>
