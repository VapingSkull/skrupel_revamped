...
include (lang_dir . $language . "/lang.admin.index.php");
...
<frame name="rahmenk" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/aufbau.php?fu=0" target="_self">
     ...
     <frameset framespacing="0" border="false" frameborder="0" cols="60,18,*,18,60">
        <frame name="rahmen10" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/aufbau.php?fu=0" target="_self">
          ...
          <frame name="rahmen12" scrolling="auto" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>admin/welcome.php?fu=1" target="_self">
                    <frameset framespacing="0" border="false" frameborder="0" rows="80,*,92">
...
<frameset framespacing="0" border="false" frameborder="0" cols="387,*,364">
          <frame name="mitte2links" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/aufbau.php?fu=31" target="_self">
          ...
          <frame name="mitte2mitte" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/aufbau.php?fu=32" target="_self">
         </frameset>
         <frameset framespacing="0" border="false" frameborder="0" cols="56,*,19">
          <frame name="untenlinks" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>admin/menu.php?fu=2" target="_self">
          <frame name="untenmitte" scrolling="auto" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>admin/menu.php?fu=1" target="_self">
...
<body text="#000000" bgcolor="#000000" scroll="no" background="<?php echo servername;?>bilder/hintergrund.gif" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<script language="JavaScript">
<!--
if(parent.frames.length>=1) {
window.top.location.href="<?php echo servername;?>admin/index.php";
}
//-->
function check() {
...
<center><table border="0" height="100%" cellspacing="0" cellpadding="0">
    <tr>
    <td><table border="0" cellspacing="0" cellpadding="0" background="<?php echo servername;?>bilder/login.gif">
             <tr>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="628" height="1"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
             </tr>
             <tr>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="347"></td>
                <td valign="top"><center>
                <img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="30"><br>
        <img src="<?php echo servername;?>bilder/logo_login.gif" width="329" height="208">
                <br>
             <table border="0" cellspacing="0" cellpadding="4">
                 <tr>
          <td><form action="<?php echo servername;?>admin/index.php" method="post" name="formular" onSubmit="return check();"></td>
