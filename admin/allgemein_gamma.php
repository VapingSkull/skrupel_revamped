                            ...
                            if (@file_exists('../extend/'.$ext['ordner'])) {
                                if ($ext['activate']==1) {
                                    if (@intval(substr($spiel_extend,$ext['activatepos'],1))==1) {
                                        ...
                                        ?>
                                            <br><br><form name="formular" method="post" action="<?php echo servername;?>admin/allgemein_gamma.php?fu=2&pos=<?php echo $ext['activatepos']; ?>&value=0"><input type='submit' value='<?php echo $lang['admin']['allgemein']['gamma']['deaktivieren']?>' class='button'></form>
                                        <?php
                                    } else {
                                        echo $lang['admin']['allgemein']['gamma']['n_aktiviert'];
                                        ?>
                                            <br><br><form name="formular" method="post" action="<?php echo servername;?>admin/allgemein_gamma.php?fu=2&pos=<?php echo $ext['activatepos']; ?>&value=1"><input type='submit' value='<?php echo $lang['admin']['allgemein']['gamma']['aktivieren']?>' class='button'></form>
                                        <?php
                                    }
                        ...
                        <td>
                            ...
                            <center>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td><form name="formular"  method="post" action="<?php echo servername;?>admin/allgemein_gamma.php?fu=1"></td>
