...
?>
  <tr>
  	  <td valign="top" style="color:#c9c9c9;"><?php echo $id;?></td>
  ...
  if ($spielanzahl>=1) {
   ...
   if ($i2<$spielanzahl-1) { echo " - "; }
     ...
     <tr>
     <td><form method="POST" action="mitspieler_alpha.php?fu=10"></td>
     <td><input type="hidden" name="id" value="<?php echo $id;?>"></td>
     <td><input type="hidden" name="nick" value="<?php echo $nick;?>"></td>
     <td><input type="hidden" name="email" value="<?php echo $email;?>"></td>
     <td><input type="submit" name="submit" value="<?php echo $lang['admin']['mitspieler']['beta']['bearbeiten']?>" style="width:120px;"></td>
     <td></form></td></tr>
   </table></td>
  </tr>
<?php }} ?>
