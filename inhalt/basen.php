...
if ($fuid==1) {
    ...
    <body text="#000000" <?php if (@intval(substr($spieler_optionen,17,1))!=1) { ?>onload="document.getElementById('bodycontent').style.width = (document.getElementById('bodytable').offsetWidth) + 'px';CSBfleXcroll('bodybody');"<?php } ?> style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <?php
        $sql = "SELECT * FROM " . table_prefix . "sternenbasen where besitzer = '" . $spieler . "' and status = '1' and spiel = '" . $spiel . "' order by name";
        $zeiger = $Db->Execute($sql);
        $basenanzahl = $zeiger->recordCount();
        if ($basenanzahl>=1) {
            ?>
            <center>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr><?php
                                    for  ($i=0; $i<$basenanzahl;$i++) {
                                        ...
                                        if ($art==1) { 
                                                        $basisbild='2.jpg'; $icon='erf_1.gif'; $artname=$lang['basen']['raumwerft']; 
                                                     } 
                                        elseif ($art==2) { 
                                                          $basisbild='3.jpg'; $icon='erf_2.gif'; $artname=$lang['basen']['kampfstation']; 
                                                     }
                                         elseif ($art==0) { 
                                                            $basisbild='1.jpg'; $icon='erf_3.gif'; $artname=$lang['basen']['sternenbasis']; 
                                        }
                                         elseif ($art==3) { 
                                                            $basisbild='4.jpg'; $icon='erf_5.gif'; $artname=$lang['basen']['kriegsbasis']; }
                                        ...
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo servername;?>/inhalt/basen.php?fu=2&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"><img src="<?php
                                                        $file= daten_dir . $rasse.'/bilder_basen/'.$basisbild;
                                                        if (@file_exists($file)) { echo servername.'daten/'.$rasse.'/bilder_basen/'.$basisbild; } else { echo servername.'daten/'.$rasse.'/bilder_basen/1.jpg'; }?>" border="0"  height="80" title="<?php echo $tip; ?>"></a>
                                                    </td>
                                                    <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td><center><a href="javascript:;" onclick="movemap(<?php echo $x_pos.",".$y_pos;  ?>);"><img src="<?php echo servername;?>bilder/icons/<?php echo $icon; ?>" border="0"></a></center></td>
                                                            </tr>
                                                            <tr>
...
if ($fuid==2) {
    ...
    <frameset framespacing="0" border="false" frameborder="0" cols="*,26,290,167,420,26,*">
        ...
        <frame name="pfeillinks" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=7&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
        <frame name="planeten" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=3&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
        <?php if ($zug_abgeschlossen==0) { ?>
            <frame name="planetenmenu" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
        <?php } else { ?>
            <frame name="planetenmenu" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=5&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
        <?php } ?>
        <frame name="planetendetails" scrolling="auto" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=6&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
        <frame name="pfeilrechts" scrolling="no" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/basen.php?fu=8&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
...
if ($fuid==3) {
    ...
    $zeiger = "SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."'";
    ...
    /*$zeiger = @mysql_query("SELECT id,cantox,besitzer,min1,min2,min3 FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."'");
    $array = @mysql_fetch_array($zeiger);*/
    $zeiger = "SELECT id,cantox,besitzer,min1,min2,min3 FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."'";
    $array = $Db->getRow($zeiger);
    $pid=$array["id"];
    $cantox=$array["cantox"];
    $min1=$array["min1"];
    ...
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="movemap(<?php echo $x_pos.",".$y_pos;  ?>);">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td rowspan="2"><?php if (($art==0) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/huelle.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
            ...
            <tr>
                ...
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td rowspan="2"><?php if (($art==0) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/antrieb.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
            ...
            <tr>
                ...
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td rowspan="2"><?php if (($art==0) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/laser.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
            ...
            <tr>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td rowspan="2"><?php if (($art==0) or ($art==2) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/abwehr.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td colspan="2" style="color:#aaaaaa;"><?php if (($art==0) or ($art==2) or ($art==3)) { ?><?php echo $lang['basen']['abwehr']; ?><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td rowspan="2"><?php if (($art==0) or ($art==2) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/hangar.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td colspan="2" style="color:#aaaaaa;"><?php if (($art==0) or ($art==2) or ($art==3)) { ?><?php echo $lang['basen']['jaeger']; ?><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                <td rowspan="2"><?php if (($art==0) or ($art==3)) { ?><img src="<?php echo servername;?>bilder/icons/projektil.gif" border="0" width="17" height="17"><?php } ?></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
...
if ($fuid==4) {
    $art = $Db->getOne("SELECT art FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."'");
    /*$zeiger = @mysql_query("SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."'");    
    $array = @mysql_fetch_array($zeiger);
    $art=$array["art"];*/
    ?>
    ...
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="167" height="6"></td>
            </tr>
            <tr>
                <td><img src="<?php echo servername;?>bilder/konsole/basis_<?php echo $art; ?>.gif" border="0" width="167" height="95" usemap="#konsole"></td>
            </tr>
        </table>
        <?php if (($art==0) or ($art==3)) { ?>
            <map name="konsole">
                <area shape="rect" coords="24,14,50,40" href="javascript:linksub('<?php echo servername;?>inhalt/basen_alpha.php?fu=1&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['techlevel']; ?>">
                <area shape="rect" coords="71,11,97,39" href="javascript:linksub('<?php echo servername;?>inhalt/basen_alpha.php?fu=3&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['abwehrsysteme']; ?>">
                <area shape="rect" coords="112,12,144,42" href="javascript:linksub('<?php echo servername;?>inhalt/basen_alpha.php?fu=5&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['raumfaltentechnologie']; ?>">

                <area shape="rect" coords="16,54,33,66" href="javascript:linksub('<?php echo servername;?>inhalt/basen_beta.php?fu=1&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['ruempfe']; ?>">
                <area shape="rect" coords="40,54,56,67" href="javascript:linksub('<?php echo servername;?>inhalt/basen_beta.php?fu=3&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['antriebssysteme']; ?>">
                <area shape="rect" coords="17,73,33,89" href="javascript:linksub('<?php echo servername;?>inhalt/basen_beta.php?fu=5&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['energetischewaffen']; ?>">
                <area shape="rect" coords="39,75,56,86" href="javascript:linksub('<?php echo servername;?>inhalt/basen_beta.php?fu=7&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['projektilbasierendewaffen']; ?>">

                <area shape="rect" coords="72,59,98,83" href="javascript:linksub('<?php echo servername;?>inhalt/basen_gamma.php?fu=1&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['schiffproduzieren']; ?>">
                <area shape="rect" coords="114,62,144,84" href="javascript:linksub('<?php echo servername;?>inhalt/basen_gamma.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['logbuch']; ?>">
            </map>
        <?php }elseif ($art==1) { ?>
            <map name="konsole">
                <area shape="rect" coords="114,62,144,84" href="javascript:linksub('<?php echo servername;?>inhalt/basen_gamma.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['logbuch']; ?>">
...
if ($fuid==5) {
    ...
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td><img src="<?php echo servername;?>bilder/konsole/sternenbasis_no.gif" border="0" width="167" height="95" usemap="#konsole"></td>
            </tr>
        </table>
        <map name="konsole">
            <area shape="rect" coords="114,62,144,84" href="javascript:linksub('<?php echo servername;?>inhalt/basen_gamma.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();" title="<?php echo $lang['basen']['logbuch']; ?>">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php
                                    $file= daten_dir.$rasse.'/bilder_basen/'.$basisbild;
                                    if (@file_exists($file)) { echo servername . 'daten/'.$rasse.'/bilder_basen/'.$basisbild; } else { echo servername.'daten/'.$rasse.'/bilder_basen/1.jpg'; }?>" border="0"  height="94" title="<?php echo $artname; ?>" width="141">
                                </td>
                                <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            </tr>
                            <tr>
...
if ($fuid==7) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php
        $zeiger = @mysql_query("SELECT id FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and spiel='".$spiel."' order by name");
            ...
            for  ($i=0; $i<$planetenanzahl;$i++) {
                ...
                if (($baid==$pid_t) and ($i>=1)) { ?>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><a href="javascript:linksub('<?php echo servername;?>inhalt/basen.php?fu=2&baid=<?php echo $pid_back; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();"><img src="<?php echo servername;?>bilder/konsole/pfeil_links.gif" border="0" width="26" height="90"></a></td>
                        </tr>
                    </table>
                    <?php
                }
            ...
            for  ($i=0; $i<$planetenanzahl;$i++) {
                ...
                if ($baid==$pid_back) { ?>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><a href="javascript:linksub('<?php echo servername;?>inhalt/basen.php?fu=2&baid=<?php echo $pid_t; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>');self.focus();"><img src="<?php echo servername;?>bilder/konsole/pfeil_rechts.gif" border="0" width="26" height="90"></a></td>
                        </tr>
                    </table>
                    <?php
                }
