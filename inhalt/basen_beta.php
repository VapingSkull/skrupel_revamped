 ...
 */
$lang = get_phrasen('de', 'basenbeta');

$fuid = intval($params["fu"]);
$baid = intval($params["baid"]);

if ($fuid==1) {
    include (inhalt_dir . "inc.header.php");
    $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."'");
    ...
    $jaeger=$array["jaeger"];
    $zeiger2 = @mysql_query("SELECT id,cantox,besitzer,min1,min2,min3 FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."'");
    ...
    $min3=$array2["min3"];
    /* 
     * Die Daten der Rassen und sonstiges die aus Dateien eingelesen werden kommen auch in die Datenbank ! Das ganze ist wesentlich schneller.
     */
    $file=daten_dir.$rasse.'/schiffe.txt';
    $fp = @fopen($file,"r");
    if ($fp) {
        $zaehler=0;
        while (!feof ($fp)) {
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td></td>
                <td></td>
                <td><a href="javascript:hilfe(9);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
            ...
            for ($i=0;$i<$zaehler;$i++) {
                ...
                $anzahl=0;
                $zeiger = @mysql_query("SELECT count(*) as total FROM " . table_prefix . "huellen where baid='".$baid."' and klasse='".$schiffwert[1]."'");
                $array = @mysql_fetch_array($zeiger);
                $anzahl=$array["total"];
                ?>
                <tr>
                    ...
                    <td>
                        <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_beta.php?fu=2&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
            ...
            if ($spieler_rasse=='kuatoh') {
                $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "konplaene where besitzer='".$spieler."' and spiel='".$spiel."' order by techlevel,klasse");
                ...
                if ($plananzahl>=1) {
                    for  ($i=0; $i<$plananzahl;$i++) {
                        ...
                        $anzahl=0;
                        $zeiger2 = @mysql_query("SELECT count(*) as total FROM " . table_prefix . "huellen where baid='".$baid."' and klasse='".$klasseid."' and rasse='".$rasses."'");
                        $array2 = @mysql_fetch_array($zeiger2);
                        $anzahl=$array2["total"];
                        ?>
                        <tr>
                            <td><img src="<?php echo servername;?>/bilder/empty.gif" border="0" width="1" height="18"></td>
                            <td>
                                <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_beta.php?fu=9&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
...
if ($fuid==2) {
    ...
    for ($i=0;$i<$zaehler;$i++) {
        $schiffwert=explode(':',$schiff[$i]);
        if ($schiffwert[1]==intval($params["schiffid"])) {
            if (($cantox>=$schiffwert[5]) and 
                ($min1>=$schiffwert[6]) and 
                ($min2>=$schiffwert[7]) and 
                ($min3>=$schiffwert[8] and 
                ($schiffwert[2]<=$t_huelle))) {
                $cantox=$cantox-$schiffwert[5];
                $min1=$min1-$schiffwert[6];
                $min2=$min2-$schiffwert[7];
                $min3=$min3-$schiffwert[8];
                $Db->execute("UPDATE " . table_prefix . "planeten set cantox='".$cantox."',min1='".$min1."',min2='".$min2."',min3='".$min3."' where besitzer='".$spieler."' and id='".$planetid."'");
                $Db->execute("INSERT INTO " . table_prefix . "huellen (spiel,baid,klasse,bild_gross,bild_klein,crew,masse,tank,fracht,antriebe,energetik,projektile,hangar,klasse_name,rasse,fertigkeiten,techlevel) 
                                                                              values ('".$spiel."','".$baid."','".$schiffwert[1]."','".$schiffwert[3]."',
                                                                                      '".$schiffwert[4]."','".$schiffwert[15]."','".$schiffwert[16]."',
                                                                                      '".$schiffwert[13]."','".$schiffwert[12]."','".$schiffwert[14]."',
                                                                                      '".$schiffwert[9]."','".$schiffwert[10]."','".$schiffwert[11]."',
                                                                                      '".$schiffwert[0]."','".$rasse."','".$schiffwert[17]."','".$schiffwert[2]."')");
...
if ($fuid==3) {
    ...
    $min2=$array2["min2"];
    $min3=$array2["min3"];
    $name = array($lang['basenbeta']['antriebe0'],
    $lang['basenbeta']['antriebe1'],
    $lang['basenbeta']['antriebe2'],
    $lang['basenbeta']['antriebe3'],
    $lang['basenbeta']['antriebe4'],
    $lang['basenbeta']['antriebe5'],
    $lang['basenbeta']['antriebe6'],
    $lang['basenbeta']['antriebe7'],
    $lang['basenbeta']['antriebe8']);
    $kosten =    array(
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <script language=JavaScript>
            function antriebdetail(aid) {
                oben=100;
                links=Math.ceil((screen.width-580)/2);
                window.open('<?php echo servername;?>inhalt/hilfe_antriebe.php?fu2='+aid+'&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>','Hilfe','resizable=yes,scrollbars=no,width=580,height=180,top='+oben+',left='+links);
            }
        </script>
        <table border="0" cellspacing="0" cellpadding="2">
            <tr>
            ...
            for($i=1;$i<10;$i++){
                ...
                ?>
                <tr>
                    <td><img src="<?php servername;?>bilder/empty.gif" border="0" width="1" height="18"></td>
                    <td>
                        <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_beta.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
                    ...
                    if (($cantox>=$kosten[0][$i-1]) and ($t_antrieb>=$i+$j) and ($min1>=$kosten[1][$i-1]) and ($min2>=$kosten[2][$i-1]) and ($min3>=$kosten[3][$i-1])) {
                        ...
                        <td>
                            <select name="anzahl" style="width:40px;">
                                <?php
                                for ($kn=1;$kn<11;$kn++) {
                                    if (($cantox>=$kosten[0][$i-1]*$kn) and 
                                        ($min1>=$kosten[1][$i-1]*$kn) and 
                                        ($min2>=$kosten[2][$i-1]*$kn) and 
                                        ($min3>=$kosten[3][$i-1]*$kn)) {
                                        ?>
...
if ($fuid==4) {
    ...
    $antriebname = array ("",$lang['basenbeta']['antriebe0'],
    $lang['basenbeta']['antriebe1'],
    $lang['basenbeta']['antriebe2'],
    $lang['basenbeta']['antriebe3'],
    $lang['basenbeta']['antriebe4'],
    ...
    $anzahl=intval($params["anzahl"]);
    $stufe=intval($params["stufe"]);
    if (($cantox>=$kosten[$stufe]*$anzahl) and 
        ($min1>=$minkosten_1[$stufe]*$anzahl) and 
        ($min2>=$minkosten_2[$stufe]*$anzahl) and 
        ($min3>=$minkosten_3[$stufe]*$anzahl) and 
        ((($stufe<8) 
            and ($stufe<=$t_antrieb)) or 
                (($stufe>7) and 
                    ($stufe<$t_antrieb)))) {
        ...
        $zeiger_temp = @mysql_query("UPDATE " . table_prefix . "planeten set cantox='".$cantox."',min1='".$min1."',min2='".$min2."',min3='".$min3."' where besitzer='".$spieler."' and id='".$planetid."'");
        $zeiger_temp = @mysql_query("UPDATE " . table_prefix . "sternenbasen set vorrat_antrieb_1='".$vorrat_antrieb_1."',
                                                                                 vorrat_antrieb_2='".$vorrat_antrieb_2."',
                                                                                 vorrat_antrieb_3='".$vorrat_antrieb_3."',
                                                                                 vorrat_antrieb_4='".$vorrat_antrieb_4."',
                                                                                 vorrat_antrieb_5='".$vorrat_antrieb_5."',
                                                                                 vorrat_antrieb_6='".$vorrat_antrieb_6."',
                                                                                 vorrat_antrieb_7='".$vorrat_antrieb_7."',
                                                                                 vorrat_antrieb_8='".$vorrat_antrieb_8."',
                                                                                 vorrat_antrieb_9='".$vorrat_antrieb_9."' where besitzer='".$spieler."' and id='".$baid."'");
...
if ($fuid==5) {
    ...
    $waffen = array ("",$lang['basenbeta']['waffen0'],
    $lang['basenbeta']['waffen1'],
    $lang['basenbeta']['waffen2'],
    $lang['basenbeta']['waffen3'],
    $lang['basenbeta']['waffen4'],
    $lang['basenbeta']['waffen5'],
    $lang['basenbeta']['waffen6'],
    $lang['basenbeta']['waffen7'],
    $lang['basenbeta']['waffen8'],
    $lang['basenbeta']['waffen9']);
        ...
        <table border="0" cellspacing="0" cellpadding="2">
            ...
            <?php  for($n=1;$n<11;$n++){
                ...
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="18"></td>
                    <td>
                        <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_beta.php?fu=6&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
...
if ($fuid==6) {
    include (inhalt_dir . "inc.header.php");
    $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."' order by besitzer, id");
    $array = @mysql_fetch_array($zeiger);
    $baid=$array["id"];
    $name=$array["name"];
    $x_pos=$array["x_pos"];
    ...
    $vorrat_energetik_9=$array["vorrat_energetik_9"];
    $vorrat_energetik_10=$array["vorrat_energetik_10"];
    $zeiger2 = @mysql_query("SELECT id,cantox,besitzer,min1,min2,min3 FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."' order by besitzer, id");
    $array2 = @mysql_fetch_array($zeiger2);
    $pid=$array2["id"];
    $cantox=$array2["cantox"];
    $min1=$array2["min1"];
    ...
    if (($cantox>=$kosten[$stufe]*$anzahl) and ($min1>=$minkosten_1[$stufe]*$anzahl) and ($min2>=$minkosten_2[$stufe]*$anzahl) and ($min3>=$minkosten_3[$stufe]*$anzahl) and ($techlevel[$stufe]<=$t_energie)) {
        ...
        $Db->execute("UPDATE " . table_prefix . "planeten set cantox='".$cantox."',min1='".$min1."',min2='".$min2."',min3='".$min3."' where besitzer='".$spieler."' and id='".$planetid."'");
        $Db->execute("UPDATE " . table_prefix . "sternenbasen set vorrat_energetik_1='".$vorrat_energetik_1."',vorrat_energetik_2='".$vorrat_energetik_2."',vorrat_energetik_3='".$vorrat_energetik_3."',
                                                                                 vorrat_energetik_4='".$vorrat_energetik_4."',vorrat_energetik_5='".$vorrat_energetik_5."',vorrat_energetik_6='".$vorrat_energetik_6."',
                                                                                 vorrat_energetik_7='".$vorrat_energetik_7."',vorrat_energetik_8='".$vorrat_energetik_8."',vorrat_energetik_9='".$vorrat_energetik_9."',
                                                                                 vorrat_energetik_10='".$vorrat_energetik_10."' where besitzer='".$spieler."' and id='".$baid."'");
...
if ($fuid==7) {
    ...
    $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."' order by besitzer");
    $array = @mysql_fetch_array($zeiger);
    $baid=$array["id"];
    $name=$array["name"];
    $x_pos=$array["x_pos"];
    ...
    $waffen = array ("",$lang['basenbeta']['waffen10'],
                        $lang['basenbeta']['waffen11'],
                        $lang['basenbeta']['waffen12'],
                        $lang['basenbeta']['waffen13'],
                        $lang['basenbeta']['waffen14'],
                        $lang['basenbeta']['waffen15'],
                        $lang['basenbeta']['waffen16'],
                        $lang['basenbeta']['waffen17'],
                        $lang['basenbeta']['waffen18'],
                        $lang['basenbeta']['waffen19']);
        ...
        <table border="0" cellspacing="0" cellpadding="2">
            ...
            for($n=1;$n<11;$n++) {
                ...
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="18"></td>
                    <td>
                        <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_beta.php?fu=8&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
                    ...
                    <td <?php if ($var_wert==0) { echo 'style="color:#aaaaaa;"';} ?>><center><?php echo $var_wert; ?></center></td>
                    <?php
                    if (($cantox>=$kosten[$n]) and 
                        ($t_explosiv>=$techlevel[$n]) and 
                        ($min1>=$minkosten_1[$n]) and 
                        ($min2>=$minkosten_2[$n]) and 
                        ($min3>=$minkosten_3[$n])) {
                        ?>
                        <td>
                            <select name="anzahl" style="width:40px;">
                                <?php for ($kn=1;$kn<11;$kn++) {
                                    if (($cantox>=$kosten[$n]*$kn) and 
                                        ($min1>=$minkosten_1[$n]*$kn) and 
                                        ($min2>=$minkosten_2[$n]*$kn) and 
                                        ($min3>=$minkosten_3[$n]*$kn)) {
                                        ?>
                                        <option value="<?php echo $kn; ?>"><?php echo $kn; ?></option>
                                        <?php
                                    }
...
if ($fuid==8) {
    include (inhalt_dir . "inc.header.php");
    $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "sternenbasen where besitzer='".$spieler."' and status='1' and id='".$baid."' order by besitzer, status");
    $array = @mysql_fetch_array($zeiger);
    $baid=$array["id"];
    $name=$array["name"];
    $x_pos=$array["x_pos"];
    ...
    $vorrat_projektile_9=$array["vorrat_projektile_9"];
    $vorrat_projektile_10=$array["vorrat_projektile_10"];
    $zeiger2 = @mysql_query("SELECT id,cantox,besitzer,min1,min2,min3 FROM " . table_prefix . "planeten use index (besitzer,PRIMARY) where besitzer='".$spieler."' and id='".$planetid."' order by besitzer,id");
    $array2 = @mysql_fetch_array($zeiger2);
    $pid=$array2["id"];
    $cantox=$array2["cantox"];
    $min1=$array2["min1"];
    ...
    if (($cantox>=$kosten[$stufe]*$anzahl) and 
        ...
        $Db->execute("UPDATE " . table_prefix . "planeten set cantox='".$cantox."',min1='".$min1."',min2='".$min2."',min3='".$min3."' where besitzer='".$spieler."' and id='".$planetid."'");
        $Db->execute("UPDATE " . table_prefix . "sternenbasen set vorrat_projektile_1='".$vorrat_projektile_1."',vorrat_projektile_2='".$vorrat_projektile_2."',vorrat_projektile_3='".$vorrat_projektile_3."',
                                                                                 vorrat_projektile_4='".$vorrat_projektile_4."',vorrat_projektile_5='".$vorrat_projektile_5."',vorrat_projektile_6='".$vorrat_projektile_6."',
                                                                                 vorrat_projektile_7='".$vorrat_projektile_7."',vorrat_projektile_8='".$vorrat_projektile_8."',vorrat_projektile_9='".$vorrat_projektile_9."',
                                                                                 vorrat_projektile_10='".$vorrat_projektile_10."' where besitzer='".$spieler."' and id='".$baid."'");
...
if ($fuid==9) {
    ...
    $min2=$array2["min2"];
    $min3=$array2["min3"];
    $zeiger3 = @mysql_query("SELECT * FROM " . table_prefix . "konplaene where besitzer='".$spieler."' and spiel='".$spiel."' and id='".intval($params["schiffid"])."'");
    ...
    $schiffwert=explode(':',$sonstiges);
    if (($cantox>=$schiffwert[2]) and 
        ($min1>=$schiffwert[3]) and 
        ($min2>=$schiffwert[4]) and 
        ($min3>=$schiffwert[5])) {
        ...
        $Db->execute("UPDATE " . table_prefix . "planeten set cantox='".$cantox."',min1='".$min1."',min2='".$min2."',min3='".$min3."' where besitzer='".$spieler."' and id='".$planetid."'");
        $Db->execute("INSERT INTO " . table_prefix . "huellen (spiel,baid,klasse,bild_gross,bild_klein,crew,masse,tank,fracht,antriebe,energetik,projektile,hangar,klasse_name,rasse,fertigkeiten,techlevel) 
                                                                      values ('".$spiel."','".$baid."','".$klasseid."','".$schiffwert[0]."','".$schiffwert[1]."','".$schiffwert[12]."','".$schiffwert[13]."',
                                                                              '".$schiffwert[10]."','".$schiffwert[9]."','".$schiffwert[11]."','".$schiffwert[6]."','".$schiffwert[7]."','".$schiffwert[8]."',
                                                                              '".$klasse."','".$rasses."','".$schiffwert[14]."','".$techlevel."')");
