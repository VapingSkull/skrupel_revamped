...
include (lang_dir . sprache .'/lang.runde_ende.php');

$spiel = @intval($prams["spiel"]);
    ...
    <html>
    	...
    	<meta http-equiv="imagetoolbar" content="no">
            <script language="JavaScript">
                if(parent.frames.length>=1) {
                    window.top.location.href="<?php echo servername;?>inhalt/runde_ende.php?fu=1&spiel=<?php echo $spiel;?>";
                }
            </script>
        </head>
        <frameset framespacing="0" border="false" frameborder="0" rows="*,18,508,16,*">
            ...
            <frameset framespacing="0" border="false" frameborder="0" cols="*,18,862,18,*">
                ...
                <frame name="rahmen12" scrolling="auto" marginwidth="0" marginheight="0" noresize src="<?php echo servername;?>inhalt/runde_ende.php?fu=2&spiel=<?php echo $spiel;?>>&sprache=<?php echo sprache;?>" target="_self">
                <frameset framespacing="0" border="false" frameborder="0" rows="80,*,92">
...
if ($fuid==2) {
    $zeiger = "SELECT extend,serial FROM " . table_prefix . "info";
    ...
    $array_out = $Db->getArray("SELECT * FROM " . table_prefix . "spiele where phase='1' and id='".$spiel."'");   
    foreach($array_out as $array) {        
            ...
            <body text="#000000" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td><img src="<?php echo servername;?>bilder/logo_login.gif" width="329" height="208"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                        <td width="100%">
                            <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td width="100%" valign="top">
                            <center>
                                <table border="0" cellspacing="0" cellpadding="3" width="100%">
                                    <tr>
                                        <td width="100%"><img src="<?php echo servername;?>lang/<?php echo $sprache?>/topics/dieimperien.gif" border="0" width="185" height="52"></td>
                                        <td><center><img src="<?php echo servername;?>bilder/aufbau/rang_1.gif" border="0" width="41" height="41"></center></td>
                                        <td><center><img src="<?php echo servername;?>bilder/aufbau/rang_2.gif" border="0" width="41" height="41"></center></td>
                                        <td><center><img src="<?php echo servername;?>bilder/aufbau/rang_3.gif" border="0" width="41" height="41"></center></td>
                                        <td><center><img src="<?php echo servername;?>bilder/aufbau/rang_4.gif" border="0" width="113" height="41"></center></td>
                                    </tr>
                                    <?php 
                                    if ($spieler_1>=1) {                                        
                                        $username=$Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_1."'");
                                    ...
                                    if ($spieler_2>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_2."'");                                         
                                    ...
                                    if ($spieler_3>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_3."'");                                         
                                    ...
                                    if ($spieler_4>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_4."'");                                        
                                    ...
                                    if ($spieler_5>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_5."'");                                        
                                    ...
                                    if ($spieler_6>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_6."'");                                        
                                    ...
                                    if ($spieler_7>=1) {
                                        $username= $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_7."'");                                        
                                    ...
                                    if ($spieler_8>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_8."'");                                        
                                    ...
                                    if ($spieler_9>=1) {
                                        $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_9."'");                                        
                                     ...
                                     if ($spieler_10>=1) {
                                         $username = $Db->getOne("SELECT nick FROM " . table_prefix . "user where id='".$spieler_10."'");                                        
                        ...
                        <td>
                            <?php 
                            $moviegif_verzeichnis = extend_dir . 'moviegif';
                                            ...
                                            <center>
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><iframe src="<?php echo servername;?>extend/moviegif/movie.php?fu=1&spiel=<?php echo $spiel;?>" width="250" height="250" name="map" scrolling="no" marginheight="0" marginwidth="0" frameborder="0"></iframe></td>
                                        ...
                                        <td>
                                            <center>
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo servername;?>bilder/aufbau/galalinks.gif" border="0" width="4" height="250"></td>
                                                        <td><iframe src="<?php echo servername;?>inhalt/runde_ende.php?fu=3&spiel=<?php echo $spiel?>" width="250" height="250" name="map" scrolling="no" marginheight="0" marginwidth="0" frameborder="0"></iframe></td>
                                                        <td><img src="<?php echo servername;?>bilder/aufbau/galarechts.gif" border="0" width="4" height="250"></td>
                                                    <tr>
                                                        <td colspan="3"><img src="<?php echo servername;?>bilder/aufbau/galaunten.gif" border="0" width="258" height="4"></td>
                                                    </tr>
...
if ($fuid==3) {
    ...
    $hoehe=250;
    compressed_output();
    $umfang = $Db->getOne("SELECT umfang FROM " . table_prefix . "spiele use index (PRIMARY) where id='" . $spiel . "'")
            ?>
        <html>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="Author" content="Bernd Kantoks bernd@kantoks.de">
        ...
        <meta http-equiv="imagetoolbar" content="no">
            ...
            <body text="#000000" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                ...
                for ($n=1;$n<=$sektoranzahl;$n++) {
                    ...
                    ?>
                    <div id="strich<?php echo $n?>" style="position: absolute; left:<?php echo $x?>px; top:0px; width:1px; height:<?php echo $hoehe?>px;visibility=visible;background-Color:#333333;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="1" height="<?php echo $hoehe?>"></div>
                    <?php 
                }
                for ($n=1;$n<=$sektoranzahl;$n++) {
                    $y=(250*$n)/$umfang*$hoehe;
                    ?>
                    <div id="strich<?php echo $n+5?>" style="position: absolute; left:0px; top:<?php echo $y?>px; width:<?php echo $breite?>px; height:1px;visibility=visible;background-Color:#333333;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="<?php echo $breite?>" height="1"></div>
                    <?php
                }               
                $Db->setFetchMode(ADODB_FETCH_BOTH);
                $array_out = $Db->getArray("SELECT * FROM " . table_prefix . "schiffe use index (spiel) where spiel='".$spiel."' order by id");
                foreach ($array_out as $array){
                    $id=$array["id"];
                    $x_pos=$array["kox"];
                    $y_pos=$array["koy"];
                ...
                $Db->setFetchMode(ADODB_FETCH_BOTH);
                $array_out = $Db->getArray("SELECT * FROM " . table_prefix . "planeten use index (spiel) where spiel='".$spiel."' order by id");
                    ...
                    foreach ($array_out as $array) {                        
                        ...
                        if ($besitzer==0) {
                            ?>
                            <div id="planet_<?php echo $id?>" style="position: absolute; left:<?php echo $x_position?>px; top:<?php echo $y_position?>px; width:1px; height:1px;visibility=visible;background-Color:#ffffff;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="1" height="1"></div>
                            <?php
                        } else {
                            $farbe=$spielerfarbe["$besitzer"];
                            ?>
                ...
                $Db->setFetchMode(ADODB_FETCH_BOTH);
                $array_out = $Db->getArray("SELECT * FROM " . table_prefix . "anomalien use index (art,spiel) where art in ('1','2') and spiel='".$spiel."' order by id");
                    foreach ($array_out as $array) {                        
                        $aid=$array["id"];
                        $art=$array["art"];
                        $x_pos=$array["x_pos"];
                        ...
                        $nummer=rand(1,6);
                        ?>
                        <div id="anomalie_<?php echo $aid?>" style="position: absolute; left:<?php echo $x_position; ?>px; top:<?php echo $y_position; ?>px; width:1px; height:1px;visibility=visible;"><img border="0" src="<?php echo servername;?>bilder/export/anomalie_<?php echo $nummer?>.gif" width="1" height="1"></div>
                        <?php 
                    }
