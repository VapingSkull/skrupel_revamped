...
if ($fuid>=1) {
    ...
    <frameset framespacing="0" border="false" frameborder="0" rows="18,*,16">
        ...
        <frameset framespacing="0" border="false" frameborder="0" cols="18,*,18">
            ...
            <frame name="rahmen12" scrolling="auto" marginwidth="0" marginheight="0" noresize src="<?php echo servername?>inhalt/hilfe.php?fu=<?php if (int_get('fu2')>=1) {echo int_get('fu2');} else {echo "9999";} ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" target="_self">
