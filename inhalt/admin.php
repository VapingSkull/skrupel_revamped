      ...
      <tr>
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=11&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
        ...
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=7&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
    ...
    if($ziel_id==0){
      ?>
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=3&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
    ...
    ?>
      ...
      <tr>
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=1&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
        ...
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=9&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
    ...
    if($ziel_id==0){
      ?>
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=5&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
    ...
    ?>
        ...
        <tr>
          ...
          <td>
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=12&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
        ...
        <td>
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/admin.php?fu=14&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
...
<body onLoad="window.location='<?php echo servername;?>inhalt/uebersicht.php?fu=1&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>';" text="#ffffff" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  <br><br><br><br>
  <center>
    <?php
...
if ($fuid==3) {
  ...
  <center>
      ...
      ?>
            <body text="#ffffff" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                <img src="<?php echo servername;?>bilder/empty.gif" width="1" height="3"><br>
                <center>
                    <table border="0" cellspacing="0" cellpadding="4">
                        ...
                        <tr>
                            <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=4&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
...
if ($fuid==4) {
    ...
    if ($spieler==$spieler_admin) {
        ...
        if (($uid>1) and ($spieler_1<>$uid) 
                     and ($spieler_2<>$uid) 
                     and ($spieler_3<>$uid) 
                     and ($spieler_4<>$uid) 
                     and ($spieler_5<>$uid) and ($spieler_6<>$uid) and ($spieler_7<>$uid) and ($spieler_8<>$uid) and ($spieler_9<>$uid) and ($spieler_10<>$uid)) {
...
if ($fuid==5) {
    ...
    if ($spieler==$spieler_admin) {
        ?>
        <body text="#ffffff" style="background-image:url('<?php echo servername;?>biler/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <?php
            $zahl=0;
            ...
            if ($zahl>=1) {
                ...
                <center>
                    <table border="0" cellspacing="0" cellpadding="7">
                        ...
                        <tr>
                            <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=6&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                            <td>
                                <center>
        ...
        <body text="#ffffff" style="background-image:url('<?php echo servername;?>biler/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <center>
                <table border="0" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        <td colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="12"></td>
                    </tr>
                </table>
            </center>
            <center>
                <table border="0" cellspacing="0" cellpadding="1">
                    <tr>
                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=8&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                    ...
                    <tr>
                        <td colspan="5"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                    </tr>
                    <tr>
                        <td></td>
            ...
            <center>
                <table border="0" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:hilfe(36);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                    </tr>
                </table>
            </center>
            <center>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=10&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                    ...
                    <tr>
                        <td colspan="4"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="6"></td>
                    </tr>
                    <tr>
                        <td></td>
...
if ($fuid==10) {
    ...
    if ($spieler==$spieler_admin) {
        ...
        ?>
        <body text="#ffffff" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#444444" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <br><br><br><br>
            <?php if ($plasma_max==0) { ?>
...
if ($fuid==11) {
    ...
    if ($spieler==$spieler_admin) {
        ...
        <body text="#000000" bgcolor="#444444"  style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;"  link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            <script language=JavaScript>
                window.location='<?php echo servername;?>inhalt/admin.php?fu=2&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>';
            </script>
            <?php
        include ("inc.footer.php");
    }
    ...
    if ($spieler==$spieler_admin) {
        ...
        <body text="#ffffff" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            <center>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="8"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="10"></td>
                    </tr>
                    <tr>
                        <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=13&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
    ...
    if ($spieler==$spieler_admin) {
        ...
        <body text="#ffffff" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#444444" link="#ffffff" vlink="#ffffff" alink="#ffffff" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            <center>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/admin.php?fu=15&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                    </tr>
                    <tr>
