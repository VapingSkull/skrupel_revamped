...
$lang = get_phrasen('de', 'planetenbeta');
$fuid = intval($params["fu"]);
$pid = intval($params["pid"]);

if ($fuid==1) {
include (inhalt_dir ."inc.header.php");
    $zeiger = "SELECT besitzer,id,native_id,native_name,native_art_name,native_abgabe,native_bild,native_text,native_kol FROM " . table_prefix . "planeten use index (besitzer,PRIMARY) where besitzer='".$spieler."' and id='".$pid."'";
                    ...
                    <td width="100%">
                        <center>
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="6"></td>
                                </tr>
                                <tr>
                                    <td>
                                        <center>
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/native_2.gif" border="0" width="17" height="17"></td>
                                                    ...
                                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="6" height="6"></td>
                    ...
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo servername;?>daten/bilder_spezien/<?php echo $native_bild?>" border="0" width="97" height="97"></td>
                                <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            </tr>
                            <tr>
                                <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
...
if ($fuid==2) {
    include (inhalt_dir ."inc.header.php");
    $logbuch=$Db->getOne("SELECT logbuch FROM " . table_prefix . "planeten use index (PRIMARY) where id='".$pid."'");
    ?>
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    ...
                    <td><a href="javascript:hilfe(31);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
            </table>
        </center>
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_beta.php?fu=3&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
...
if ($fuid==3) {
    ...
    $Db->execute("UPDATE " . table_prefix . "planeten set logbuch='".$eintrag."' where id='".$pid."'");
    ?>
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <br><br><br><br>
...
if ($fuid==4) {
    include (inhalt_dir . "inc.header.php");
    $zeiger = "SELECT x_pos,y_pos FROM " . table_prefix . "planeten where id='".$pid."'";
    $array = $Db->getRow($zeiger);
    $xpos=$array["x_pos"];
    $ypos=$array["y_pos"];
    $s_zahl=0;
    $zeiger = "SELECT * FROM " . table_prefix . "schiffe use index (kox,koy,besitzer,spiel) where kox='".$xpos."' and koy='".$ypos."' and besitzer='".$spieler."' and spiel='".$spiel."' order by name";
    $result = $Db->execute($zeiger);
    $schiffanzahl = $result->recordCount();    
    if ($schiffanzahl>=1) {
        ...
        for ($i=0; $i<$schiffanzahl;$i++) {
            ...
            if ($routing_status>=1) {
                ...
                for ($n=0;$n<$schritte-1;$n++) {
                    ...
                    $name = $Db->getOne("SELECT name FROM " . table_prefix . "planeten where x_pos='".$zielx."' and y_pos='".$ziely."' and spiel='".$spiel."'");
    ...
    <script language="JavaScript">
        function link_schiff(shid_t,oid_t) {
            if (parent.parent.mittelinksoben.document.globals.map.value==0) {
                ...
                parent.parent.mittemitte.window.location='<?php echo servername;?>inhalt/galaxie.php?fu=2&uid=<?php echo $uid?>&sid=<?php echo $sid?>';
      }
//            else {
//                parent.parent.mittemitte.aktuell.style.visibility='hidden';
//            }
            parent.parent.untenmitte.window.location='<?php echo servername;?>inhalt/flotte.php?fu=2&shid='+shid_t+'&oid='+oid_t+'&uid=<?php echo $uid;?>&sid=<?php echo $sid;?>';
        }
    </script>
                        ...
                        <tr>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                        <td><a href="javascript:;" ><img src="<?php echo servername;?>daten/<?php echo $schiff_scan[$i][3]?>/bilder_schiffe/<?php echo $schiff_scan[$i][4]?>" onclick="link_schiff(<?php echo $schiff_scan[$i][0]?>,<?php echo $schiff_scan[$i][9]?>);body.focus();" border="0" height="50" width="75" title="<?php echo $schiff_scan[$i][8]?>"></a></td>
                                        <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
