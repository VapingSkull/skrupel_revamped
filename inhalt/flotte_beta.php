...
/* 
 * Sprache aus Datenbank laden und zusammenführen start
 */
$lang1 =  get_phrasen('de', 'flottebeta');
$lang2 =  get_phrasen('de', 'basen');
$lang = array_merge ($lang1,$lang2);
/*
 * Sprache aus Datenbank laden und zusammenführen ende
 */
...
if ($fuid==1) {
    ...
    $sql = "SELECT * FROM " . table_prefix . "planeten where sqrt(((x_pos-$kox)*(x_pos-$kox))+((y_pos-$koy)*(y_pos-$koy)))<=$reichweite  and besitzer<>$spieler and spiel=$spiel order by id";
    ...
    $sql = "SELECT * FROM " . table_prefix . "schiffe where sqrt(((kox-".$kox.")*(kox-".$kox."))+((koy-".$koy.")*(koy-".$koy.")))<=".$reichweite." and besitzer<>".$spieler." and tarnfeld<2 and spiel='".$spiel."' order by id";
    $zeiger = $Db->Execute($sql);
    $schiffanzahl = $zeiger->recordCount();
    
    if ($schiffanzahl>=1) {
        $raumschiffe=$schiffanzahl;
            $array_out = $Db->GetArray($sql);
            foreach ($arrout_out as $arr){
                $array = $arr;
            }
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <script language="JavaScript">
            function nativedetail(shid) {
                ...
                window.open('<?php echo servername;?>inhalt/hilfe_native.php?fu2='+shid+'&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>','domspezien','resizable=yes,scrollbars=no,width=580,height=180,top='+oben+',left='+links);
            }
        </script>
        ...
        <center>
            <table border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    ...
                    <td><a href="javascript:hilfe(14);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
                <tr>
                    ...
                    for  ($i=0; $i<$p_zahl;$i++) { 
                        ...
                        <tr>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($planet_scan[$i][10])) { echo $spielerfarbe[$planet_scan[$i][10]]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($planet_scan[$i][10])) { echo $spielerfarbe[$planet_scan[$i][10]]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                        <td><img src="<?php echo servername;?>bilder/planeten/<?php echo $planet_scan[$i][9]; ?>_<?php echo $planet_scan[$i][4]; ?>.jpg" border="0"  height="50"></td>
                                        <td bgcolor="<?php if (0 < intval($planet_scan[$i][10])) { echo $spielerfarbe[$planet_scan[$i][10]]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($planet_scan[$i][10])) { echo $spielerfarbe[$planet_scan[$i][10]]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            ...
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                            <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/flotte_beta.php?fu=2&pid=<?php echo $planet_scan[$i][5]; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                            <td><input type="submit" name="bla" value="<?php echo $lang['flottebeta']['detailscan']; ?>" style="width:70px;"></td>
                            <td></form></td>
                        </tr>
                        <tr>
                            <td colspan="7"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="5"></td>
                        </tr>
                        <?php
                    }
                    ?>
                    ...
                    for  ($i=0; $i<$s_zahl;$i++) {
                        ...
                        <tr>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($schiff_scan[$i][7])) { echo $spielerfarbe[$schiff_scan[$i][7]]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($schiff_scan[$i][7])) { echo $spielerfarbe[$schiff_scan[$i][7]]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                        <td><img src="<?php echo servername;?>daten/<?php echo $schiff_scan[$i][3]; ?>/bilder_schiffe/<?php echo $schiff_scan[$i][4]; ?>" border="0"  height="50" width="75"></td>
                                        <td bgcolor="<?php if (0 < intval($schiff_scan[$i][7])) { echo $spielerfarbe[$schiff_scan[$i][7]]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="<?php if (0 < intval($schiff_scan[$i][7])) { echo $spielerfarbe[$schiff_scan[$i][7]]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            ...
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                            <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/flotte_beta.php?fu=3&shid=<?php echo $schiff_scan[$i][0]; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                            <td><input type="submit" name="bla" value="<?php echo $lang['flottebeta']['detailscan']; ?>" style="width:70px;"></td>
                            <td></form></td>
                        </tr>
                        <tr>
...
if ($fuid==2) {
   ...
   //include (lang_dir . $spieler_sprache."/lang.basen.php");

    $pid=intval($params["pid"]);

    $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "planeten where id=$pid");
    ...
    if (0 < $sternenbasis) {
        $defense = $Db->getOne("SELECT defense FROM " . table_prefix . "sternenbasen where id='".$sternenbasis_id."'");        
        /*$zeiger = @mysql_query("SELECT defense FROM " . table_prefix . "sternenbasen where id=$sternenbasis_id");
        $array = @mysql_fetch_array($zeiger);
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><img src="<?php echo servername;?>bilder/icons/<?php echo $icon; ?>" border="0" title="<?php echo $artname; ?>"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="25" height="1"></td>
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            ...
                            <tr>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            </tr>
                            <tr>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                <td>
                                    <img src="<?php
                                    $file='../daten/'.$sternenbasis_rasse.'/bilder_basen/'.$basisbild;
                                    if (@file_exists($file)) { echo $file; } else { echo servername .'/daten/'.$sternenbasis_rasse.'/bilder_basen/1.jpg'; }?>" border="0"  height="94" title="<?php echo $artname; ?>" width="141">
                                </td>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                <td><img src="<?php echo servername;?>bilder/planeten/<?php echo $klasse; ?>_<?php echo $bild; ?>.jpg" border="0"  height="91"></td>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            </tr>
                            <tr>
                                <td bgcolor="<?php if (0 < intval($besitzer)) { echo $spielerfarbe[$besitzer]; } else { echo '#aaaaaa';} ?>" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    ...
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="5"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="15" height="1"></td>
                    <td>
                        <img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="6">
                        <br>
                        <iframe src="<?php echo servername;?>inhalt/flotte_beta.php?fu=10&pid=<?php echo $pid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" width="97" height="97" name="map" scrolling="no" marginheight="0" marginwidth="0" frameborder="0"></iframe>
                    </td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    <td valign="top"></td>
                </tr>
...
if ($fuid==3) {
    ...
    $antriebsnamen = array ("",$lang['flottebeta']['antriebe0'],$lang['flottebeta']['antriebe1'],$lang['flottebeta']['antriebe2'],
                               $lang['flottebeta']['antriebe3'],$lang['flottebeta']['antriebe4'],$lang['flottebeta']['antriebe5'],
                               $lang['flottebeta']['antriebe6'],$lang['flottebeta']['antriebe7'],$lang['flottebeta']['antriebe8']);
    $antrieb=$antriebsnamen[$antrieb];
    $projektilnamen = array ($lang['flottebeta']['nichtvorhanden'],$lang['flottebeta']['waffen10'],$lang['flottebeta']['waffen11'],
                             $lang['flottebeta']['waffen12'],$lang['flottebeta']['waffen13'],$lang['flottebeta']['waffen14'],
                             $lang['flottebeta']['waffen15'],$lang['flottebeta']['waffen16'],$lang['flottebeta']['waffen17'],
                             $lang['flottebeta']['waffen18'],$lang['flottebeta']['waffen19']);
    $projektile=$projektilnamen[$projektile_stufe];
    $energetiknamen = array ($lang['flottebeta']['nichtvorhanden'],$lang['flottebeta']['waffen0'],$lang['flottebeta']['waffen1'],
                             $lang['flottebeta']['waffen2'],$lang['flottebeta']['waffen3'],$lang['flottebeta']['waffen4'],
                             $lang['flottebeta']['waffen5'],$lang['flottebeta']['waffen6'],$lang['flottebeta']['waffen7'],
                             $lang['flottebeta']['waffen8'],$lang['flottebeta']['waffen9']);
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            </tr>
                            <tr>
                                <td rowspan="2"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="17"></td>
                                ...
                                <td colspan="2">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo servername;?>daten/<?php echo $volk; ?>/bilder_schiffe/<?php echo $bild_klein; ?>" border="0" width="75" height="50"></td>
                                            <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    ...
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/masse.gif" border="0" width="17" height="17"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/antrieb.gif" border="0" width="17" height="17"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                            ...
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/laser.gif" border="0" width="17" height="17"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                            ...
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/hangar.gif" border="0" width="17" height="17"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
...
if ($fuid==4) {
    ...
    <body text="#000000" scroll="auto" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <div id="bodybody" class="flexcroll" onfocus="this.blur()">
    <?php
    $reichweite=0;
    if ($erwtrans>=1) {
    ...
    $zeiger_temp = @mysql_query("SELECT * FROM " . table_prefix . "planeten where sqrt(((x_pos-".$kox.")*(x_pos-".$kox."))+((y_pos-".$koy.")*(y_pos-".$koy.")))<=".$reichweite." and spiel='".$spiel."'");  
    ...
    if ($datensaetze_temp>=1) {
        ...
        if ($besitzer==$spieler) {
            ...
            if(($planet_kolonisten==0)and($p_leichtebt==0)and($p_schwerebt==0)){
                ...
                $Db->execute("UPDATE " . table_prefix . "planeten set kolonisten_spieler='0' where id='".$pid."'");
            }
            ...
            $zeiger = @mysql_query("SELECT spiel,partei_a,partei_b,status,optionen FROM " . table_prefix . "politik where spiel='".$spiel."'");
...
<?php
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><form name="formular" onsubmit="return checken();"  method="post" action="<?php echo servername;?>inhalt/flotte_beta.php?fu=5&shid=<?php echo $shid; ?>&pid=<?php echo $pid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="230" height="5"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="60" height="5"></td>
            </tr>
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            <td><img src="<?php echo servername;?>daten/<?php echo $volk; ?>/bilder_schiffe/<?php echo $bild_klein; ?>" border="0" height="50"></td>
                            <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                        </tr>
                        <tr>
                            <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    ...
                    <center>
                        <table border="0" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:hilfe(15);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                            </tr>
                            <tr>
                                <td colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="3"></td>
                            </tr>
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                            <td><img src="<?php echo servername;?>bilder/planeten/<?php echo $klasse; ?>_<?php echo $bild; ?>.jpg" border="0"  height="50"></td>
                            <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                        </tr>
                        <tr>
                            <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
            ...
            <tr>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="77" height="5"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="230" height="5"></td>
                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="60" height="5"></td>
            </tr>
        </table>
        ...
        if ((($besitzer!=$spieler) and ($beziehung[$besitzer][$spieler]['status']==5))or(($kolonisten_spieler_t!=0)and ($kolonisten_spieler_t!=$spieler))) {
                ...
                if ($infanterie!=1) {
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="77" height="1"></td>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="230" height="1"></td>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="60" height="1"></td>
                        </tr>
                        <tr>
                            <td>
                                <center>
                                    <img src="<?php echo servername;?>bilder/icons/crew.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['kolonisten']; ?>">
                                    <br>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo servername;?>bilder/icons/leichtebt.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['leichtebt']; ?>">
                                <br>
                ...
                if ($infanterie!=1) {
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <center>
                                    <img src="<?php echo servername;?>bilder/icons/schwerebt.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['schwerebt']; ?>">
                                    <br>
            ...
            if ($infanterie!=1) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo servername;?>bilder/icons/cantox.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['cantox']; ?>">
                                <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/vorrat.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['vorraete']; ?>">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/lemin.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['lemin']; ?>">
                            <br>
            ...
            if ($infanterie!=1) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo servername;?>bilder/icons/mineral_1.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['baxterium']; ?>">
                                <br>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo servername;?>bilder/icons/mineral_2.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['rennurbin']; ?>">
                                <br>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <center>
                                <img src="<?php echo servername;?>bilder/icons/mineral_3.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['vomisaan']; ?>">
                                <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="367" height="5"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td></form><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="367" height="5"></td>
                </tr>
            </table>
            <?php
        } else {
...
if ($fuid==5) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php
        $pid=intval($params["pid"]);
        $zeiger_temp = @mysql_query("SELECT * FROM " . table_prefix . "planeten where id=$pid");
        $array_temp = @mysql_fetch_array($zeiger_temp);
        ...
        $planet_kolonisten = (!intval($params["planet_kolonisten"]))?0:intval($params["planet_kolonisten"]);
        $planet_cantox = (!intval($params["planet_cantox"]))?0:intval($params["planet_cantox"]);
        $planet_vorrat = (!intval($params["planet_vorrat"]))?0:intval($params["planet_vorrat"]);
        $planet_lemin = (!intval($params["planet_lemin"]))?0:intval($params["planet_lemin"]);
        $planet_min1 = (!intval($params["planet_min1"]))?0:intval($params["planet_min1"]);
        $planet_min2 = (!intval($params["planet_min2"]))?0:intval($params["planet_min2"]);
        $planet_min3 = (!intval($params["planet_min3"]))?0:intval($params["planet_min3"]);
        $fracht_leute = (!intval($params["fracht_leute"]))?0:intval($params["fracht_leute"]);
        $fracht_cantox = (!intval($params["fracht_cantox"]))?0:intval($params["fracht_cantox"]);
        $fracht_vorrat = (!intval($params["fracht_vorrat"]))?0:intval($params["fracht_vorrat"]);
        $fracht_lemin = (!intval($params["fracht_lemin"]))?0:intval($params["fracht_lemin"]);
        $fracht_min1 = (!intval($params["fracht_min1"]))?0:intval($params["fracht_min1"]);
        $fracht_min2 = (!intval($params["fracht_min2"]))?0:intval($params["fracht_min2"]);
        $fracht_min3 = (!intval($params["fracht_min3"]))?0:intval($params["fracht_min3"]);
        $p_leichtebt = (!intval($params["p_leichtebt"]))?0:intval($params["p_leichtebt"]);
        $p_schwerebt = (!intval($params["p_schwerebt"]))?0:intval($params["p_schwerebt"]);
        $s_leichtebt = (!intval($params["s_leichtebt"]))?0:intval($params["s_leichtebt"]);
        $s_schwerebt = (!intval($params["s_schwerebt"]))?0:intval($params["s_schwerebt"]);
        ...
        if (($planet_kolonisten>=0) and ($p_leichtebt>=0) and ($p_schwerebt>=0) and ($planet_cantox>=0) and ($planet_vorrat>=0) and ($planet_lemin>=0) and ($planet_min1>=0) and ($planet_min2>=0) and ($planet_min3>=0) and ($fracht_leute>=0) and ($s_leichtebt>=0) and ($s_schwerebt>=0) and ($fracht_cantox>=0) and ($fracht_vorrat>=0) and ($fracht_lemin>=0) and ($fracht_min1>=0) and ($fracht_min2>=0) and ($fracht_min3>=0)) {
            $s_zeiger = @mysql_query("SELECT * FROM " . table_prefix . "schiffe where id=$shid");
            ...
            $s_zeiger = @mysql_query("SELECT * FROM " . table_prefix . "spiele where id='".$s_spiel."'");
            $s_array = @mysql_fetch_array($s_zeiger);
            $s_besitzer="spieler_".$s_besitzer;
            $s_spieler_id=$s_array[$s_besitzer];
            $s_zeiger = @mysql_query("SELECT uid FROM " . table_prefix . "user where id='".$s_spieler_id."");
            $s_array = @mysql_fetch_array($s_zeiger);
            $s_uid=$s_array["uid"];
            if($s_uid===$uid){
                ...
                if(max(($s_kox-$s_x_pos),($s_koy-$s_y_pos))<=(($s_erwtrans>=1) ? 25 : 0)){
                    if((($s_infanterie==1)and($s_schwerebt==0)and($fracht_leute==0)and($fracht_cantox==0)and($fracht_min1==0)and($fracht_min2==0)and($fracht_min3==0))or($s_infanterie==0)){
                        if (    ($besitzer==$spieler)
                            ...
                            $Db->Execute("UPDATE " . table_prefix . "planeten set leichtebt='".$p_leichtebt."',schwerebt='".$p_schwerebt."',kolonisten='".$planet_kolonisten."',cantox='".$planet_cantox."',vorrat='".$planet_vorrat."',lemin='".$planet_lemin."',min1='".$planet_min1."',min2='".$planet_min2."',min3='".$planet_min3."' where id='".$pid."'");
                            $Db->Execute("UPDATE " . table_prefix . "schiffe set leichtebt='".$s_leichtebt."',schwerebt='".$s_schwerebt."',fracht_leute='".$fracht_leute."',fracht_cantox='".$fracht_cantox."',fracht_vorrat='".$fracht_vorrat."',lemin='".$fracht_lemin."',fracht_min1='".$fracht_min1."',fracht_min2='".$fracht_min2."',fracht_min3='".$fracht_min3."' where id='".$shid."'");
                        }elseif(
                                ($besitzer!=$spieler)
                            ...
                            if(($planet_kolonisten+$p_leichtebt+$p_schwerebt)>0){
                                $Db->Execute("UPDATE " . table_prefix . "planeten set leichtebt_new='".$p_leichtebt."',
                                                                                      schwerebt_new='".$p_schwerebt."',
                                                                                      kolonisten_spieler='".$spieler."',
                                                                                      kolonisten_new='".$planet_kolonisten."',
                                                                                      cantox='".$planet_cantox."',
                                                                                      vorrat='".$planet_vorrat."',
                                                                                      lemin='".$planet_lemin."',
                                                                                      min1='".$planet_min1."',
                                                                                      min2='".$planet_min2."',
                                                                                      min3='".$planet_min3."' 
                                ...
                                $Db->Execute("UPDATE " . table_prefix . "schiffe set leichtebt='".$s_leichtebt."',
                                                                                     schwerebt='".$s_schwerebt."',
                                                                                     fracht_leute='".$fracht_leute."',
                ...
                echo "Transport konnte nicht komplett durchgeführt werden. Schiff noch unterwegs";
            }
        }
        ?>
        <script language="JavaScript">
        ...
        if ($datensaetze_temp>=1) {
            ...
            if ((($besitzer!=$spieler) and ($beziehung[$besitzer][$spieler]['status']==5))or(($kolonisten_spieler_t!=0)and ($kolonisten_spieler_t!=$spieler))) {
                ...
                if ($infanterie!=1) { ?>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><center><img src="<?php echo servername;?>bilder/icons/crew.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['kolonisten']; ?>"></center></td>
                            <td>
                                <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><center><img src="<?php echo servername;?>bilder/icons/leichtebt.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['leichtebt']; ?>"></center></td>
                        <td>
                            <center>
                ...
                if ($infanterie!=1) {
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><center><img src="<?php echo servername;?>bilder/icons/schwerebt.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['schwerebt']; ?>"></center></td>
                            <td>
                                <center>
            ...
            if ($infanterie!=1) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><center><img src="<?php echo servername;?>bilder/icons/cantox.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['cantox']; ?>"></center></td>
                        <td>
                            <center>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><center><img src="<?php echo servername;?>bilder/icons/vorrat.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['vorraete']; ?>"></center></td>
                    <td>
                        <center>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td><center><img src="<?php echo servername;?>bilder/icons/lemin.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['lemin']; ?>"></center></td>
                    <td>
                        <center>
            ...
            if ($infanterie!=1) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><center><img src="<?php echo servername;?>bilder/icons/mineral_1.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['baxterium']; ?>"></center></td>
                        <td>
                            <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><center><img src="<?php echo servername;?>bilder/icons/mineral_2.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['rennurbin']; ?>"></center></td>
                        <td>
                            <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><center><img src="<?php echo servername;?>bilder/icons/mineral_3.gif" border="0" width="17" height="17" title="<?php echo $lang['flottebeta']['vomisaan']; ?>"></center></td>
                        <td>
                            <center>
...
if ($fuid==8) {
    include(inhalt_dir ."inc.header.php");
    $sql = "SELECT logbuch FROM " . table_prefix . "schiffe where id=$shid";
    $logbuch = $Db->GetOne($sql);
    ...
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="1">
                <tr>
                    <td colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="2"></td>
                </tr>
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="17" height="17"></td>
                    <td><center><?php echo $lang['flottebeta']['logbuch']; ?></center></td>
                    <td><a href="javascript:hilfe(17);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
            </table>
        </center>
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/flotte_beta.php?fu=9&shid=<?php echo $shid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
...
if ($fuid==9) {
    include(inhalt_dir ."inc.header.php");
    $eintrag = $params["logbuchdaten"];
    $Db->execute("UPDATE " . table_prefix . "schiffe set logbuch='".$eintrag."' where id='".$shid."'");
    ?>
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <br><br><br><br>
...
if ($fuid==10) {
    include(inhalt_dir ."inc.header.php");
    $sql = "SELECT * FROM " . table_prefix . "planeten where id ='" . intval($params["pid"]) . "' order by id";
    $array_out = $Db->GetArray($sql);
    foreach ($array_out as $arr){
        $array = $arr;
    }
    ...
    function mineral($min,$anzahl,$kon) {
        ...
        for  ($i=0; $i<$punkteanzahl;$i=$i+($kon*2)) {
            ...
            if ($kon==1) {
                ...
                ?>
                <div id="p_<?php echo $i; ?>" style="position: absolute; left:<?php echo $x; ?>px; top:<?php echo $y; ?>px; width:1px; height:1px;visibility=visible;background-Color:<?php echo $minfarben[$min]; ?>;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="1" height="1"></div>
                <?php
                ...
                for  ($p=0; $p<$punkte;$p++) {
                    ...
                    ?>
                    <div id="p_<?php echo $p?>_<?php echo $i; ?>" style="position: absolute; left:<?php echo $xpos; ?>px; top:<?php echo $ypos; ?>px; width:1px; height:1px;visibility=visible;background-Color:<?php echo $minfarben[$min]; ?>;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="1" height="1"></div>
                    <?php
                    $richtung=rand(0,7);
                    if ($richtung==0) { $xpos--; }
                    if ($richtung==1) { $ypos--; }
    ...
    <body text="#000000" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <img border="0" src="<?php echo servername;?>bilder/skalen/scan.gif" width="97" height="97">
        <?php 
