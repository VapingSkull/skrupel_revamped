...
if ($fuid==1) {
    ...
    <body text="#000000" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td class="forumdunkel" width="100%" colspan="2"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="25" height="20"></td>
            ...
            <tr>
                <td class="forummittel"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="25" height="20"></td>
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=1&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=2&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=3&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=4&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=5&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=6&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                ...
                <td class="forumhell" width="100%">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=7&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:12px;text-decoration:underline;">
                                    <b><?php echo $lang['kommunikationboard']['bugs']; ?></b>
                                </a>
                            </td>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                        </tr>
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td><?php echo $lang['kommunikationboard']['bugstext']; ?></td>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                        </tr>
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                    ...
                    <?php
                    $themaanzahl=0;
                    $zeiger = @mysql_query("SELECT count(*) as anzahl FROM $skrupel_forum_thema where forum=7");
                    $array = @mysql_fetch_array($zeiger);
                    $themaanzahl=$array["anzahl"];
                    $beitraganzahl=0;
                    $zeiger = @mysql_query("SELECT count(*) as anzahl FROM $skrupel_forum_beitrag where forum=7");
                    $array = @mysql_fetch_array($zeiger);
                    $beitraganzahl=$array["anzahl"];
                    $zeiger = @mysql_query("SELECT * FROM $skrupel_forum_beitrag where forum=7 order by datum desc limit 0,1");
                    $array = @mysql_fetch_array($zeiger);
                    $letzter=$array["datum"];
                    if ($letzter>=1) { $letzter=date('d.m.y G:i',$letzter); } else { $letzter=""; }
                    ?>
...
if ($fuid==2) {
    ...
    <body text="#000000" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <td class="forumdunkel" width="100%" colspan="5">
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                            <td>
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=1&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:10px;text-decoration:underline;">
            ...
            <tr>
                <td class="forumdunkel"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="25" height="20"></td>
            ...
            if ($themaanzahl>=1) {
                for ($i=0; $i<$themaanzahl;$i++) {
                    ...
                    ?>
                    <tr>
                        <td class="forummittel"><center><img src="<?php echo servername;?>bilder/forum_icons/<?php echo $icon; ?>.gif" border="0" width="15" height="15"></center></td>
                        <td class="forumhell" width="100%">
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                ...
                                <tr>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                    <td><a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=3&fo=<?php echo $forum; ?>&thema=<?php echo $id; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:10px;text-decoration:underline;"><?php echo $thema; ?></a></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                </tr>
                                <tr>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
            ...
            ?>
            <tr>
                <td class="forumdunkel" colspan="5"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="25" height="20"></td>
            </tr>
            <?php
            if ($forum>1) {
                ?>
                    ...
                    <td class="forummittel" colspan="4">
                        <center>
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/kommunikation_board.php?fu=4&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>&forum=<?php echo $forum; ?>" onSubmit="return checkeingabe();"></td>
                                ...
                                <td align="right"><nobr><?php echo $lang['kommunikationboard']['icon']; ?>&nbsp;&nbsp;</nobr></td>
                                    ...
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/1.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="2" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/2.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="3" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/3.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="4" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/4.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="5" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/5.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="6" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/6.gif" border="0" width="15" height="15"></td>
                                    <td><input type="radio" name="icon" value="7" style="background-color:#606060;border-color:#606060;";></td>
                                    <td><img src="<?php echo servername;?>bilder/forum_icons/7.gif" border="0" width="15" height="15"></td>
                                    </tr></table></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                </tr>
                                <tr>
...
if ($fuid==3) {
    ...
    if ($forum==7) { $formname=$lang['kommunikationboard']['bugs'];}
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo servername;?>inhalt/kommunikation_board.php?fu=2&fo=<?php echo $forum; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" style="color:#ffffff;font-size:10px;text-decoration:underline;">
            ...
            <tr>
                <td class="forumdunkel">
                    <center>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="20"></td>
                ...
                <td class="forummittel" colspan="4">
                    <center>
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                                <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/kommunikation_board.php?fu=5&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>&forum=<?php echo $forum; ?>&thema=<?php echo $thema; ?>" onSubmit="return checkeingabe();"></td>
