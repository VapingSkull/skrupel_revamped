...
if (!empty($langfile_1)) include (lang_dir . $spieler_sprache . '/lang.'.$langfile_1.'.php');

if (!empty($langfile_2)) include (lang_dir . $spieler_sprache . '/lang.'.$langfile_2.'.php');

$zeiger = @mysql_query("SELECT * FROM " . table_prefix . "info");
...
<head>
    ...
    <script language="JavaScript">
        function hilfe(hid) {
            ...
            window.open('<?php echo servername;?>inhalt/hilfe.php?fu2='+hid+'&uid=<?php echo $uid; ?>&sid=<?php echo $sid;?>','Hilfe','resizable=yes,scrollbars=no,width=480,height=180,top='+oben+',left='+links);
        }
    </script>
    <link href="<?php echo servername;?>inhalt/js/flexcroll/standard_grey.css" rel="stylesheet" type="text/css" />
    <?php 
        ...
        <script type="text/javascript" src="<?php echo servername;?>inhalt/js/flexcroll/flexcroll.js"></script>   
    <?php } ?>   
</head>