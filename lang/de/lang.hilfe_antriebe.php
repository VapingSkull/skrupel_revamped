...
$lang['hilfe_antriebe'][4][2]="<ul><li>Altbackende Technologie<br>Mit dieser Technologie kennt sich nahezu jeder Ingenieur aus, wodurch es ihnen mit einer Wahrscheinlichkeit von 17% pro Monat gelingt, den Leminverbrauch um 63% zu drosseln.</ul>";
$lang['hilfe_antriebe'][5][0]="Tachion-Flux";
$lang['hilfe_antriebe'][5][1]="Warp 5";
$lang['hilfe_antriebe'][5][2]="<ul><li>Unidentifizierbare Masse<br>Die verwendeten Tachionfelder st&ouml;ren die Langstreckensensoren dermassen, dass &uuml;ber sie nicht feststellbar ist, welche Masse das Schiff besitzt. Die Masse wird eher zuf&auml;llig ermittelt.</ul>";
$lang['hilfe_antriebe'][6][0]="Mikro-Grav";
$lang['hilfe_antriebe'][6][1]="Warp 6";
$lang['hilfe_antriebe'][6][2]="<ul><li>Alternativer Treibstoff<br>Diese Antriebe k&ouml;nnen zus&auml;tzlich zum Lemin auch zus&auml;tzlich mit Rennurbin betrieben werden.</ul>";
$lang['hilfe_antriebe'][7][0]="Solarisplasmotan";
$lang['hilfe_antriebe'][7][1]="Warp 7";
$lang['hilfe_antriebe'][7][2]="<ul><li>Plasmaentladungen<br>Das Solarisplasma ist eine sehr unzuverl&auml;ssige Antriebstechnologie. Es kommt regelm&auml;ssig zu Plasmaentladungen, welche die eigene Tarnung hinf&auml;llig macht. Mit einer Wahrscheinlichkeit von 19% pro Monat wird die eigene aktive Tarnung f&uuml;r einen Monat wirkungslos.</ul>";
$lang['hilfe_antriebe'][8][0]="Psiongleitnetz";
$lang['hilfe_antriebe'][8][1]="Warp 8";
$lang['hilfe_antriebe'][8][2]="<ul><li>Fehlender Traktorstrahl<br>Aufgrund der verwendeten Technologie ist es nicht m&ouml;glich mit diesem Antrieb einen Traktorstrahl zu nutzen.</ul>";
$lang['hilfe_antriebe'][9][0]="Transwarp";
$lang['hilfe_antriebe'][9][1]="Warp 9";
$lang['hilfe_antriebe'][9][2]="<ul><li>Eingeschr&auml;nkter Frachtraum<br>Die Maschinen zur Erzeugung einer Warp 9 Warpblase ben&ouml;tigen ein &uuml;berm&auml;ssiges Volumen. Ein Schiff b&uuml;sst daher bei der Konstruktion 1/2 seines Frachtraums ein.<li>Fehlender Traktorstrahl<br>Aufgrund der verwendeten Technologie ist es nicht m&ouml;glich mit diesem Antrieb einen Traktorstrahl zu nutzen.</ul>";
