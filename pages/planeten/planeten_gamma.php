...
$lang = get_phrasen('de', 'planetengamma');
                ...
                <tr>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="8"></td>
                            ...
                            <tr>
                                <td colspan="10"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="6"></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                ...
                                <td rowspan="2"><a href="javascript:hilfe(8);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        ...
                        if ($max_bau>=1) {
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=3&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                    <td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=2&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="13" height="1"></td>
                    <td>
                        <img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="6"><br>
...
if ($fuid==2) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $auto_minen=0;
        if (intval($params["minauto"])==1) { $auto_minen=1; $message="<center>".$lang['planetengamma']['mineautoja']."</center>"; } else { $auto_minen=0; $message="<center>".$lang['planetengamma']['mineautonein']."</center>"; }
        $Db->execute("update " . table_prefix . "planeten set auto_minen='".$auto_minen."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php
        echo $message;
...
if ($fuid==3) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $minenauftrag=intval($params["minenauftrag"]);
        $zeiger = "SELECT * FROM " . table_prefix . "planeten use index (besitzer, PRIMARY) where besitzer='".$spieler."' and id='".$pid."'";
        $array = $Db->getRow($zeiger);
        $pid=$array["id"];
        $minen=$array["minen"];
        ...
        $Db->execute("update " . table_prefix . "planeten set minen='".$minen."',cantox='".$cantox."',vorrat='".$vorrat."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php echo $message?>
...
if ($fuid==4) {
    ...
    ?>
    <body text="#444444" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="9"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="150" height="8"></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="color:#aaaaaa;"><?php echo $lang['planetengamma']['maximal']?></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                                <td rowspan="2"><a href="javascript:hilfe(6);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        ...
                        if ($max_bau>=1) {
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=6&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                    <td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=5&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="15" height="5"></td>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="6"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="14"></td>
                            </tr>
                            <tr>
                                <td colspan="6">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                                <td rowspan="2"><a href="javascript:hilfe(7);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        ...
                        if ($vorrat>=1) {
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=7&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                    <td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=8&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
...
if ($fuid==5) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $auto_fabriken=0;
        if (intval($params["fabrikauto"])==1) { $auto_fabriken=1;$message="<center>".$lang['planetengamma']['fabrikautoja']."</center>"; } else { $auto_fabriken=0;$message="<center>".$lang['planetengamma']['farbikautonein']."</center>"; }
        $Db->execute("update " . table_prefix . "planeten set auto_fabriken='".$auto_fabriken."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php 
        echo $message;
...
if ($fuid==6) {
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="no" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $fabrikenauftrag=intval($params["fabrikenauftrag"]);
        $zeiger = "SELECT * FROM " . table_prefix . "planeten use index (besitzer,PRIMARY) where besitzer='".$spieler."' and id='".$pid."'";
        $array = $Db->getRow($zeiger);
        $pid=$array["id"];
        $fabriken=$array["fabriken"];
        ...
        $message="<center>$fabrikenauftrag ".$lang['planetengamma']['fabrikerfolgreich']."</center>";
         $Db->execute("update " . table_prefix . "planeten set fabriken='".$fabriken."',cantox='".$cantox."',vorrat='".$vorrat."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php echo $message?>
        <script language="JavaScript">
...
if ($fuid==7) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $vorratauftrag=intval($params["vorratauftrag"]);
        $zeiger = "SELECT * FROM " . table_prefix . "planeten use index (besitzer,PRIMARY) where besitzer='".$spieler."' and id='".$pid."'";
        $array = $Db->getRow($zeiger);
        $pid=$array["id"];
        $cantox=$array["cantox"];
        ...
        $Db->execute("update " . table_prefix . "planeten set vorrat='".$vorrat."',cantox='".$cantox."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php echo $message?>
        <script language="JavaScript">
...
if ($fuid==8) {
    ...
    <body text="#000000" scroll="no" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        $Db->execute("update " . table_prefix . "planeten set auto_vorrat='".$auto_vorrat."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php
        echo $message;
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="10"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="150" height="8"></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="color:#aaaaaa;"><?php echo $lang['planetengamma']['maximal']?></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                                <td rowspan="2"><a href="javascript:hilfe(5);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                            ...
                            <tr>
                                <td colspan="10"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="7"></td>
                            </tr>
                        </table>
                        <?php
                        if ($max_bau>=1) {
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=11&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                                    <td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/planeten_gamma.php?fu=10&pid=<?php echo $pid?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                    <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="180" height="8"></td>
                            </tr>
                            <tr>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="13"></td>
                            </tr>
                            <tr>
                                <td><img src="<?php echo servername;?>bilder/icons/crew.gif" border="0" width="17" height="17"></td>
                                <td><nobr><?php echo $kolonisten?> <?php echo $lang['planetengamma']['kolonisten']?></nobr></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="4"></td>
                            </tr>
                            <tr>
...
if ($fuid==10) {
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="no" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $auto_abwehr=0;
        if (intval($params["abwehrauto"])==1) { $auto_abwehr=1;$message="<center>".$lang['planetengamma']['pdsautoja']."</center>"; } else { $auto_abwehr=0;$message="<center>".$lang['planetengamma']['pdsautonein']."</center>"; }
        $Db->execute("update " . table_prefix . "planeten set auto_abwehr='".$auto_abwehr."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php echo $message;
    include (inhalt_dir . "inc.footer.php");
...
if ($fuid==11) {
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="no" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <?php 
        $abwehrauftrag=intval($params["abwehrauftrag"]);
        $zeiger = "SELECT * FROM " . table_prefix . "planeten use index (besitzer,PRIMARY) where besitzer='".$spieler."' and id='".$pid."'";
        $array = $Db->getRow($zeiger);
        $pid=$array["id"];
        $cantox=$array["cantox"];
        ...
        $Db->execute("update " . table_prefix . "planeten set vorrat='".$vorrat."',cantox='".$cantox."',abwehr='".$abwehr."' where id='".$pid."' and besitzer='".$spieler."'");
        ?>
        <br><br>
        <?php echo $message?>
        <script language="JavaScript">
...
if ($fuid==12) {
    ...
    <body text="#000000" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        ?>
        <div id="blabla" style="position: absolute; left:0px; top:0px; width:97px; height:97px;visibility=visible;"><img border="0" src="<?php echo servername;?>bilder/empty.gif" width="97" height="97" title="<?php
