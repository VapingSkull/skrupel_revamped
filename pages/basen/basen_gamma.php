                ...
                <tr>
                    <td>
                        ...
                        if ($schiffbau_status==0) {
                            $zeiger = @mysql_query("SELECT * FROM " . table_prefix . "huellen where baid='".$baid."' order by klasse_name");
                            $huellenanzahl = @mysql_num_rows($zeiger);
                            if ($huellenanzahl>=1) {
                                ?>
                                <center>
                                    <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_gamma.php?fu=<?php if ($art==3) { echo '6'; } else { echo '2'; } ?>&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
                                        <br>
...
if ($fuid==2) {
    ...
    $zeiger2 = @mysql_query("SELECT * FROM " . table_prefix . "huellen where id='".$huellenid."'");
    ...
    $zeiger2 = @mysql_query("SELECT native_fert,native_kol FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."'");
    $array2 = @mysql_fetch_array($zeiger2);
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="9"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="7"></td>
                </tr>
                <tr>
                    <td><form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_gamma.php?fu=3&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>" onSubmit="return check();"></td>
                    <td colspan="7">
                ...
                <tr>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="17" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="150" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="17" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="5"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="150" height="5"></td>
                ...
                <tr>
                    <td colspan="9"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="8"></td>
                </tr>
                <tr>
                    <td><input type="hidden" name="rumpf" value="<?php echo $huellenid; ?>"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/laser.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="20"></td>
                    <?php
                    ...
                    ?>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="20"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/antrieb.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="20"></td>
                    <?php
                ...
                <tr>
                    <td></td>
                    <td><img src="<?php echo servername;?>bilder/icons/projektil.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="20"></td>
                    <?php
...
if ($fuid==3) {
    ...
    $zeiger_temp = @mysql_query("UPDATE " . table_prefix . "sternenbasen set schiffbau_zusatz='".$zusatz."',schiffbau_status='1',schiffbau_klasse='".$klasse."',
                                                                             schiffbau_bild_gross='".$bild_gross."',schiffbau_bild_klein='".$bild_klein."',
                                                                             schiffbau_crew='".$crew."',schiffbau_masse='".$masse."',schiffbau_tank='".$tank."', 
                                                                             schiffbau_fracht='".$fracht."',schiffbau_antriebe='".$noetig_antriebe."',
                                                                             schiffbau_energetik='".$noetig_energetik."',schiffbau_projektile='".$noetig_projektile."',
                                                                             schiffbau_hangar='".$hangar."',schiffbau_klasse_name='".$klasse_name."',schiffbau_rasse='".$rasse."',
                                                                             schiffbau_fertigkeiten='".$fertigkeiten."',schiffbau_energetik_stufe='".$energetikstufe."',
                                                                             schiffbau_projektile_stufe='".$projektilestufe."',schiffbau_techlevel='".$techlevel."',schiffbau_antriebe_stufe='".$antriebestufe."',
                                                                             schiffbau_name='".$schiffsname."' where besitzer='".$spieler."' and status='1' and id='".$baid."'");
    ...
    $zeiger_temp = mysql_query("UPDATE " . table_prefix . "sternenbasen set ".$spalte1."=".$spalte1."-".$noetig_antriebe.",
                                                                            ".$spalte2."=".$spalte2."-".$noetig_projektile.",
                                                                            ".$spalte3."=".$spalte3."-".$noetig_energetik." 
                                                                            where besitzer='".$spieler."' and status='1' and id='".$baid."'");
    $zeiger_temp = mysql_query("DELETE FROM " . table_prefix . "huellen where id='".$huellenid."'");
...
if ($fuid==4) {
    include (inhalt_dir . "inc.header.php");
    $zeiger = @mysql_query("SELECT id,logbuch FROM " . table_prefix . "sternenbasen where id='".$baid."' order by id");
    $array = @mysql_fetch_array($zeiger);
        ...
        <center>
            <table border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    ...
                    <td><a href="javascript:hilfe(32);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
            </table>
        </center>
        <center>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/basen_gamma.php?fu=5&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
...
if ($fuid==5) {
    ...
    //$eintrag=str_replace("\\", "",$eintrag);
    $zeiger = @mysql_query("UPDATE " . table_prefix . "sternenbasen set logbuch='".$eintrag."' where id='".$baid."'");
    ?>
    <body text="#000000" background="<?php echo servername;?>bilder/aufbau/14.gif" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0"">
        <br><br><br><br>
    ...
    <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <center>
            <table border="0" cellspacing="0" cellpadding="0" height="100%">
                <tr>
                    <td>
                        <center><form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_gamma.php?fu=2&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
                            <br>
