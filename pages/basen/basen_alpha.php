...
if ($fuid==1) {
    ...
    if (($art==0) or ($art==3)) {
        $zeiger = @mysql_query("SELECT id,cantox,besitzer FROM " . table_prefix . "planeten where besitzer='" . $spieler . "' and id='" . $planetid . "'");
        $array = @mysql_fetch_array($zeiger);
        $pid=$array["id"];
        $cantox=$array["cantox"];
        ?>
        <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <center>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="9"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        <td rowspan="2"><img src="<?php echo servername;?>bilder/icons/huelle.gif" border="0" width="17" height="17"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        ...
                        <td rowspan="2">
                            <form name="formular" method="post" action="<?php echo servername;?>inhalt/basen_alpha.php?fu=2&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>">
                            <?php
                            /*
                             * Hier werden erst die Formularfelder auf 0 gesetzt und weiter unter soll man diese ändern. Das funktioniert so nicht.
                             */
                            ?>
                            <!-- <input type="hidden" name="antriebtl" value="0"> -->
                            <!-- <input type="hidden" name="energietl" value="0"> -->
                           <!-- <input type="hidden" name="huelletl" value="0"> -->
                            <!-- <input type="hidden" name="explosivtl" value="0"> -->
                            <?php
                            $schalter=0;
                            /*
                             * Anscheinend hat niemand damit gerechnet das ein Level oberhalb von 10 Erreicht werden kann.
                        ...
                        <td rowspan="2"><a href="javascript:hilfe(1);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                        <td rowspan="2"><a href="javascript:hilfe(2);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                        <td rowspan="2"><a href="javascript:hilfe(3);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                        <td rowspan="2"><a href="javascript:hilfe(4);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                        <td colspan="15"></td>
                        <?php
                        if($schalter){
                            ?>
...
if ($fuid==2) {
    ...
    $kosten_energetik = array ("0","100","500","1400","3000","5500","9100","14000","20400","28500","38500");
    $kosten_explosiv = array ("0","100","500","1400","3000","5500","9100","14000","20400","28500","38500");
    $abwehrauftrag=intval($params["explosivtl"]);
    $array = @mysql_fetch_array($zeiger);
    $baid=$array["id"];
    $name=$array["name"];
    $x_pos=$array["x_pos"];
    ...
    $message="";
    if (($art==0) or ($art==3)) {
        $zeiger = @mysql_query("SELECT id,cantox,besitzer FROM " . table_prefix . "planeten where besitzer='" . $spieler . "' and id='" . $planetid . "' order by id");
        $array = @mysql_fetch_array($zeiger);
        $pid=$array["id"];
        $cantox=$array["cantox"];
        $schalter=0;
        if($t_huelle<10){
            for($li=$t_huelle+1;$li<=int_post('huelletl');$li++){
                if ($cantox>=$kosten_huelle[$li]-$kosten_huelle[$li-1]) {
                    ...
                    $Db->execute("UPDATE " . table_prefix . "planeten set cantox=cantox-" . $minus . " where besitzer='" . $spieler . "' and id='" . $planetid . "");
                    $Db->execute("UPDATE " . table_prefix . "sternenbasen set t_huelle=t_huelle+1 where besitzer=$spieler and id=$baid");
                    $cantox=$cantox-$minus;
                    $t_huelle++;
                    $schalter=1;
                }
        ...
        if($t_antrieb<10){
            for($li=$t_antrieb+1;$li<=int_post('antriebtl');$li++){
                if ($cantox>=$kosten_antrieb[$li]-$kosten_antrieb[$li-1]) {
                    ...
                    $Db->execute("UPDATE " . table_prefix . "planeten set cantox=cantox-" . $minus  . " where besitzer='" . $spieler ."' and id='" . $planetid . "'");
                    $Db->execute("UPDATE " . table_prefix . "sternenbasen set t_antrieb=t_antrieb+1 where besitzer='" . $spieler . "' and id='" . $baid . "'");
                    $cantox=$cantox-$minus;
                    $t_antrieb++;
                    $schalter=1;
                }
        ...
        if($t_energie<10){
            for($li=$t_energie+1;$li<=int_post('energietl');$li++){
                if ($cantox>=$kosten_energetik[$li]-$kosten_energetik[$li-1]) {
                    ...
                    $Db->execute("UPDATE " . table_prefix . "planeten set cantox=cantox-" . $minus . " where besitzer='" . $spieler . "' and id='" . $planetid . "'");
                    $Db->execute("UPDATE " . table_prefix . "sternenbasen set t_energie=t_energie+1 where besitzer='" . $spieler . "' and id='" . $baid . "'");
                    $cantox=$cantox-$minus;
                    $t_energie++;
                    $schalter=1;
                }
        ...
        if($t_explosiv<10){
            for($li=$t_explosiv+1;$li<=int_post('explosivtl');$li++){
                if ($cantox>=$kosten_explosiv[$li]-$kosten_explosiv[$li-1]) {
                    ...
                    $Db->execute("UPDATE " . table_prefix . "planeten set cantox=cantox-" . $minus . " where besitzer='" . $spieler . "' and id='" . $planetid . "'");
                    $Db->execute("UPDATE " . table_prefix . "sternenbasen set t_explosiv=t_explosiv+1 where besitzer='" . $spieler  . "' and id='" . $baid . "'");
                    $cantox=$cantox-$minus;
                    $t_explosiv++;
                    $schalter=1;
                }
...
if ($fuid==3) {
    ...
    if (($art==0) or ($art==2) or ($art==3)) {
        ...
        <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="10"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="5"></td>
                </tr>
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                ...
                <tr>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="3" height="1"></td>
                    <td rowspan="2"><a href="javascript:hilfe(10);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                </tr>
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
            ...
            if ($max_bau>=1) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><form name="formular"  method="post" action="<?php echo servername;?>inhalt/basen_alpha.php?fu=4&baid=<?php echo $baid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                        <td>
...
if ($fuid==4) {
    ...
    if ($art==0 || $art==2 || $art==3) {
        ...
        $zeiger = @mysql_query("update " . table_prefix . "planeten set cantox='" . $cantox . "',min2='" . $min2 . "' where id='" . $pid . "' and besitzer='" . $spieler . "'");
        $zeiger = @mysql_query("update " . table_prefix . "sternenbasen set defense='" . $defense . "' where id='" . $baid . "' and besitzer='" . $spieler . "'");
...
if ($fuid==5) {
    ...
    if (($art==0) or ($art==3)) {
        ...
        $zeiger = @mysql_query("SELECT id,cantox,besitzer,min1,min2,min3,lemin,vorrat FROM " . table_prefix . "planeten where besitzer='".$spieler."' and id='".$planetid."'");
        $array = @mysql_fetch_array($zeiger);
        $pid=$array["id"];
        ...
        <body text="#000000" scroll="auto" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            ...
            if (($t_huelle>=7) and ($t_antrieb>=8)) {
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><form name="formular" onsubmit="return checken();"  method="post" action="<?php echo servername;?>inhalt/basen_alpha.php?fu=6&baid=<?php echo $baid; ?>&pid=<?php echo $pid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>"></td>
                    ...
                    <tr>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (@file_exists($file)) { echo servername.'daten/'.$rasse.'/bilder_basen/'.$basisbild; } else { echo servername.'daten/'.$rasse.'/bilder_basen/1.jpg'; }?>" border="0" height="50">
                                    </td>
                                    <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                </tr>
                                <tr>
                            ...
                            <center>
                                <table border="0" cellspacing="0" cellpadding="1">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:hilfe(33);"><img src="<?php echo servername;?>bilder/icons/hilfe.gif" border="0" width="17" height="17"></a></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <center>
                                                <select name="zielid" style="font-family:Verdana;font-size:9px;width:170px;">
                                                    ...
                                                    <?php
                                                    $zeiger = @mysql_query("SELECT id,name,besitzer,spiel,status FROM " . table_prefix . "schiffe where besitzer='".$spieler."' and status>0 and spiel='".$spiel."' order by name");
                                                    ...
                                                    if ($nebel>=1) {
                                                        $zeiger = @mysql_query("SELECT sicht_beta,spiel,id,name,x_pos,y_pos,besitzer FROM " . table_prefix . "planeten where sicht_".$spieler."='1' and spiel='".$spiel."' and id<>".$pid." order by name");
                                                    } else {
                                                        $zeiger = @mysql_query("SELECT spiel,id,name,x_pos,y_pos,besitzer FROM " . table_prefix . "planeten where spiel='".$spiel."' and id<>".$pid." order by name");
                                                    }
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                    <td><img src="<?php echo servername;?>bilder/icons/anomalie.gif" border="0"  height="50"></td>
                                    <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                                </tr>
                                <tr>
                                    <td bgcolor="#aaaaaa" colspan="3"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/cantox.gif" border="0" width="17" height="17">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/vorrat.gif" border="0" width="17" height="17">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/lemin.gif" border="0" width="17" height="17">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/mineral_1.gif" border="0" width="17" height="17">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/mineral_2.gif" border="0" width="17" height="17">
                            <br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <center>
                            <img src="<?php echo servername;?>bilder/icons/mineral_3.gif" border="0" width="17" height="17">
                            <br>
...
if ($fuid==6) {
    ...
    if (
        ...
        $zeiger = @mysql_query("UPDATE " . table_prefix . "planeten set cantox='".$planet_cantox."',min1='".$planet_min1."',min2='".$planet_min2."',min3='".$planet_min3."',lemin='".$planet_lemin."',vorrat='".$planet_vorrat."' where besitzer='".$spieler."' and id='".$planetid."'");
        if ($zielart=='p') {
            $zeiger = @mysql_query("SELECT id,x_pos,y_pos FROM " . table_prefix . "planeten where id='".$zielid."'");
            $array = @mysql_fetch_array($zeiger);
            $px_pos=$array["x_pos"];
            $py_pos=$array["y_pos"];
        ...
        $zeiger = @mysql_query("insert into " . table_prefix . "anomalien (art,x_pos,y_pos,extra,spiel) values ('3','".$x_pos."','".$y_pos."','".$optionen."','".$spiel."')");
        ?>
        <body text="#000000" style="background-image:url('<?php echo servername;?>bilder/aufbau/14.gif'); background-attachment:fixed;" scroll="auto" bgcolor="#000000" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
            <br><br><br><br>
