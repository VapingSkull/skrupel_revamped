    ...
    <body text="#ffffff" bgcolor="#444444" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            for ($i=0;$i<$zaehler;$i++) {
                ...
                <tr>
                    <td colspan="20"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="10"></td>
                </tr>
                <tr>
                    ...
                    <td bgcolor="#aaaaaa"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    <td colspan="17"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                </tr>
                <tr>
                    <td bgcolor="#aaaaaa" rowspan="4"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    <td rowspan="4"><img src="<?php echo servername;?>daten/<?php echo $spieler_rasse?>/bilder_schiffe/<?php echo $schiffwert[3]?>" width="150" height="100"></td>
                    <td bgcolor="#aaaaaa" rowspan="4"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/cantox.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                ...
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/masse.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/mineral_1.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                ...
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/lemin.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/mineral_2.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                ...
                <tr>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/vorrat.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    ...
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/hangar.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['uebersicht']['konplaene']['hangar']?></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                    <td><?php echo $schiffwert[11]?></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                    <td><img src="<?php echo servername;?>bilder/icons/mineral_3.gif" border="0" width="17" height="17"></td>
                    <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
                ...
                <tr>
                    <td colspan="20"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="20"></td>
                </tr>
                <?php 
            }
            ...
            if ($plananzahl>=1) {
                ...
                for  ($i=0; $i<$plananzahl;$i++) {
                    ...
                    <tr>
                        <td bgcolor="#aaaaaa" rowspan="4"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                        <td rowspan="4"><img src="<?php echo servername;?>daten/<?php echo $plan_rasse?>/bilder_schiffe/<?php echo $schiffwert[0]?>" width="150" height="100"></td>
                        <td bgcolor="#aaaaaa" rowspan="4"><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="1" height="1"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="10" height="1"></td>
                        <td><img src="<?php echo servername;?>bilder/icons/crew.gif" border="0" width="17" height="17"></td>
                        <td><img src="<?php echo servername;?>bilder/empty.gif" border="0" width="5" height="1"></td>
