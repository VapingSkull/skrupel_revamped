                                ...
                                <td valign="top">
                                    <center>
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td><center><img src="<?php echo servername;?>lang/<?php echo $spieler_sprache?>/topics/siegbedingungen.gif" border="0" width="199" height="52"></center></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <center>
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td width="100%" colspan="3"><img src="<?php echo servername;?>lang/<?php echo $spieler_sprache?>/topics/dieimperien.gif" border="0" width="185" height="52"></td>
                                            ...
                                            for ($k=1;$k<11;$k++) {
                                                if ($spieler_id_c[$k]>=1) {
                                                    ...
                                                    ?>
                                                        <td><a href="<?php echo servername;?>inhalt/meta_rassen.php?fu=2&uid=<?php echo $uid?>&sid=<?php echo $sid?>&rasse=<?php echo$spieler_rasse_c[$k]?>"><img src="<?php echo servername;?>daten/<?php echo $spieler_rasse_c[$k]?>/bilder_allgemein/menu.png" width="186" height="75" border="0"></a></td>
                                                        <td>&nbsp;</td>
                                                        <td style="color:<?php echo $spielerfarbe[$k]?>;font-size:12px;" width="100%"><?php echo $spieler_rassename_c[$k]?><?php if ($spieler==$k) {?> <a href="<?php echo servername;?>inhalt/uebersicht_imperien.php?fu=2&spid=<?php echo $spieler?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>" style="font-size:9px;">(<?php echo $lang['uebersichtimperien']['edit']?>)</a><?php }?><br><br><nobr><a href="<?php echo servername;?>inhalt/uebersicht_imperien.php?fu=4&spid=<?php echo $spieler_id_c[$k]?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>"><?php echo $username?></a></nobr></td>
                        ...
                        <td>
                            <center>
                                <table border="0" cellspacing="0" cellpadding="5">
                                    <form name="formular" method="post" action="<?php echo servername;?>inhalt/uebersicht_imperien.php?fu=3&spid=<?php echo $spieler?>&uid=<?php echo $uid?>&sid=<?php echo $sid?>">
                                        <tr>
                                            <td></td>
    ...
    include ("inc.header.php");
        if ($spieler==int_get('spid')) {
            ...
            <script language=JavaScript>
                window.location='<?php echo servername;?>inhalt/uebersicht_imperien.php?fu=1&uid=<?php echo $uid?>&sid=<?php echo $sid?>';
            </script>
            <?php
        }
    include ("inc.footer.php");
